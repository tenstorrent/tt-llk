    ...
    const uint unpB_num_faces       = 4)
{
    ...
    uint unpA_ch1_x_stride = (unpA_dst_format & 0x3) == to_underlying(DataFormat::Float32)   ? 4
                             : (unpA_dst_format & 0x3) == to_underlying(DataFormat::Float16) ? 2
                                                                                             : 1;
    uint unpB_ch1_x_stride = (unpB_dst_format & 0x3) == to_underlying(DataFormat::Float32)   ? 4
    ...
    uint exp_width         = (static_cast<uint>(unpA_dst_format) >> 2) & 0x1; // 0=5-bit, 1=8-bit
    ...
    tile_descriptor.f.in_data_format = static_cast<uint>(unpA_src_format);
