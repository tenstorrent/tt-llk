    ...
    const std::uint32_t unpB_num_faces  = 4)
{
    ...
    std::uint32_t int8_math_enabled = ((unpA_dst_format & 0xF) == to_underlying(DataFormat::Int8)) ||
                                      ((unpB_dst_format & 0xF) == to_underlying(DataFormat::Int8)) || (unpA_dst_format == to_underlying(DataFormat::Int32)) ||
                                      (unpB_dst_format == to_underlying(DataFormat::Int32)) || (unpA_dst_format == to_underlying(DataFormat::UInt32)) ||
                                      (unpB_dst_format == to_underlying(DataFormat::UInt32));
    ...
    tile_descriptor.f.in_data_format = static_cast<std::uint32_t>(unpA_src_format);
