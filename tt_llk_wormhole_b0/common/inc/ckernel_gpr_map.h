...
struct p_gpr_unpack {
    ...
    constexpr static std::uint32_tTILE_SIZE               = 14; // Tile size
    constexpr static std::uint32_tTILE_OFFSET             = 15; // Tile offset
    constexpr static std::uint32_tL1_BUFFER_ADDR          = 17; // Holds address of fixed l1 buffer used for reduce in1
    constexpr static std::uint32_tTMP_LO                  = 18; // Temp data. Upper 16-bits always 0
    constexpr static std::uint32_tTMP_HI                  = 19; // Temp data. Lower 16-bits always 0
    ...
    constexpr static std::uint32_tTILE_SIZE_A             = 36; // Holds tile size for unpacker 0
    constexpr static std::uint32_tTILE_SIZE_B             = 37; // Holds tile size for unpacker 1
    constexpr static std::uint32_tKT_DIM                  = 38; // Holds matmul kt_dim
    constexpr static std::uint32_tFACE_DIM_16x16          = 40; // Holds face dimension (16x16)
    constexpr static std::uint32_tFACE_DIM_8x16           = 41; // Holds face dimension (8x16)
    constexpr static std::uint32_tFACE_DIM_4x16           = 42; // Holds face dimension (4x16)
    constexpr static std::uint32_tFACE_DIM_2x16           = 43; // Holds face dimension (2x16)
    constexpr static std::uint32_tFACE_DIM_1x16           = 44; // Holds face dimension (1x16)
    constexpr static std::uint32_tPERF_UNPACK_NUM_TILES_0 = 45; // num tiles for input operands 0-1
    constexpr static std::uint32_tPERF_UNPACK_NUM_TILES_1 = 46; // num tiles for input operands 2-3
    constexpr static std::uint32_tPERF_UNPACK_NUM_TILES_2 = 47; // num tiles for input operands 4-5
    constexpr static std::uint32_tPERF_UNPACK_NUM_TILES_3 = 48; // num tiles for input operands 6-7
    constexpr static std::uint32_tUNPACK_STRIDE =
        52; // Used to save/restore unpack A stride (UNP0_ADDR_CTRL_ZW_REG_1_Zstride
...
struct p_gpr_math {
    ...
    constexpr static std::uint32_tPERF_EPOCH_OFFSET        = 10; // The offset address for epoch variables
...
struct p_gpr_pack {
    ...
    constexpr static std::uint32_tTEMP_TILE_OFFSET  = 20; // Temp var which holds tile offset in dest
    ...
    constexpr static std::uint32_tPACK_STREAM_SYNC    = 32; // sync between pack and output stream [32:63]
    constexpr static std::uint32_tOUTPUT_ADDR_OFFSET  = 50; // output offset address that's added to OUTPUT_ADDR
    constexpr static std::uint32_tPERF_PACK_NUM_TILES = 51; // output operand num tiles
    constexpr static std::uint32_tEXP0_SEC_SIZE_BFP   = 52; // pack0,1,2,3 exp section size for bfp8,4,2
    constexpr static std::uint32_tEXP1_SEC_SIZE_BFP8  = 53; // pack1 exp section size for bfp8
    constexpr static std::uint32_tEXP2_SEC_SIZE_BFP8  = 54; // pack2 exp section size for bfp8
    constexpr static std::uint32_tEXP3_SEC_SIZE_BFP8  = 55; // pack2 exp section size for bfp8
    constexpr static std::uint32_tEXP1_SEC_SIZE_BFP4  = 57; // pack1 exp section size for bfp4
    constexpr static std::uint32_tEXP2_SEC_SIZE_BFP4  = 58; // pack2 exp section size for bfp4
    constexpr static std::uint32_tEXP3_SEC_SIZE_BFP4  = 59; // pack3 exp section size for bfp4
    constexpr static std::uint32_tEXP1_SEC_SIZE_BFP2  = 61; // pack1 exp section size for bfp2
    constexpr static std::uint32_tEXP2_SEC_SIZE_BFP2  = 62; // pack2 exp section size for bfp2
    constexpr static std::uint32_tEXP3_SEC_SIZE_BFP2  = 63; // pack3 exp section size for bfp2
};
