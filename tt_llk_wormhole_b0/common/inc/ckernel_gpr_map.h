...
struct p_gpr_unpack
{
    ...
    constexpr static uint32_t UNPACK_STRIDE           = 52;     // Used to save/restore unpack A stride (UNP0_ADDR_CTRL_ZW_REG_1_Zstride register)
                                                                // before/after unpacking directly to dest
    constexpr static uint32_t SR_UNPACK_TILIZER_STATE_0   = 54; // Save unpack state before tilizer is enabled for quick restore
    constexpr static uint32_t SR_UNPACK_TILIZER_STATE_1   = 55;
    constexpr static uint32_t SR_UNPACK_UNTILIZER_STATE_0 = 56; // Save unpack state before tilizer is enabled for quick restore
    constexpr static uint32_t SR_UNPACK_UNTILIZER_STATE_1 = 57;
    constexpr static uint32_t SR_UNPACK_UNTILIZER_STATE_2 = 58;
    constexpr static uint32_t SR_UNPACK_UNTILIZER_STATE_3 = 59;
};
...
struct p_gpr_pack
{
    ...
    constexpr static uint32_t OUTPUT_ADDR_OFFSET  = 50; // output offset address that's added to OUTPUT_ADDR
