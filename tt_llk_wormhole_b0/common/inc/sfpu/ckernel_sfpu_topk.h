...
inline void bitonic_topk_ph3_st4_to_1(bool dir, bool &init_replay, int replay_start)
{
    ...
    if (init_replay)
    {
        __builtin_rvtt_sfprecord(replay_start, 5, true);
                ...
                switch (ph)
                {
                    case 0:
                        for (int d = 0; d < 4; d++)
                        {
                            ...
                            if (init_load)
                            {
                                __builtin_rvtt_sfprecord(0, 8, true);
                            ...
                            if (init_phase)
                            {
                                __builtin_rvtt_sfprecord(16, 5, true);
                            ...
                            if (init_store)
                            {
                                __builtin_rvtt_sfprecord(8, 8, true);
                    ...
                    case 1:
                        for (int d = 0; d < 4; d++)
                        {
                            ...
                            if (init_phase)
                            {
                                __builtin_rvtt_sfprecord(16, 6, true);
                    ...
                    case 2:
                        for (int d = 0; d < 4; d++)
                        {
                            ...
                            if (init_phase)
                            {
                                __builtin_rvtt_sfprecord(16, 9, true);
            ...
            switch (ph)
            {
                ...
                case 1:
                    if (m_iter >= 2)
                    {
                        while (datums_compared < total_datums_to_compare)
                        {
                            ...
                            if (init_rebuild)
                            {
                                __builtin_rvtt_sfprecord(0, 22, true);
                    ...
                    else
                    {
                        ...
                        while (datums_compared < total_datums_to_compare)
                        {
                            ...
                            if (init_rebuild)
                            {
                                __builtin_rvtt_sfprecord(0, 26, true);
                ...
                case 2:
                    while (datums_compared < total_datums_to_compare)
                    {
                        ...
                        if (init_rebuild)
                        {
                            __builtin_rvtt_sfprecord(0, 29, true);
                ...
                case 3:
                    while (datums_compared < total_datums_to_compare)
                    {
                        ...
                        if (init_rebuild)
                        {
                            ...
                            __builtin_rvtt_sfprecord(13, 12, true);
                            bitonic_topk_store16<true>(4, 8);
                            TTI_INCRWC(0, 8, 0, 0);
                            TTI_INCRWC(0, 8, 0, 0);
                            TTI_INCRWC(0, 8, 0, 0);
                ...
                default:
                    ...
                    while (datums_compared < total_datums_to_compare)
                    {
                        if (init_rebuild)
                        {
                            ...
                            bitonic_topk_load16(4, 8);
                            bitonic_topk_ph3_st4_to_1(dir, init_rebuild, 8);
                            __builtin_rvtt_sfprecord(13, 8, true);
                            bitonic_topk_store16<true>(4, 8);
                        }
                        else
                        {
