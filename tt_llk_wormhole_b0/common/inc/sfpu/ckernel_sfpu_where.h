...
inline void _calculate_where_(const uint32_t dst_index_in0, const uint32_t dst_index_in1, const uint32_t dst_index_in2, const uint32_t dst_index_out)
{
    static_assert(
...
inline void _init_where_()
{
    ...
    {
        constexpr uint32_t simple_bits = 0x00 | 0x00 | (0 << 3) | 4;
    ...
    // Macro 2:
    {
        constexpr uint32_t simple_bits = 0x00 | 0x00 | (0 << 3) | 5;
        constexpr uint32_t mad_bits    = 0;
