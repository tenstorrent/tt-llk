 ...
 * This allows for a branch free (and much smaller algorithm) to compute integer value
 *
 ...
 * value has been divided by 2^23. Output value will be scaled by 2^23 compared to 'val'.
