...
sfpi_inline void _compute_ema_math_()
{
    ...
    // Step 3: Write the new value to the input register
    TTI_SFPMUL(ckernel::p_sfpu::LCONST_1, ckernel::p_sfpu::LREG7, ckernel::p_sfpu::LCONST_0, ckernel::p_sfpu::LREG0, 0);
    ...
    // LREG7 = (LREG6 * LREG1) + LREG7 = (1-α) * input + α * EMA_old
    TTI_SFPMAD(ckernel::p_sfpu::LREG6, ckernel::p_sfpu::LREG1, ckernel::p_sfpu::LREG7, ckernel::p_sfpu::LREG7, 0);
    // Next cycle cannot read from LREG7 (2-cycle operation)

    TTI_SFPNOP; // Pipeline delay

    // Step 6: Write the new value to the input register
    TTI_SFPMUL(ckernel::p_sfpu::LCONST_1, ckernel::p_sfpu::LREG7, ckernel::p_sfpu::LCONST_0, ckernel::p_sfpu::LREG1, 0);
    ...
    // LREG7 = (LREG6 * LREG2) + LREG7 = (1-α) * input + α * EMA_old
    TTI_SFPMAD(ckernel::p_sfpu::LREG6, ckernel::p_sfpu::LREG2, ckernel::p_sfpu::LREG7, ckernel::p_sfpu::LREG7, 0);
    // Next cycle cannot read from LREG7 (2-cycle operation)

    TTI_SFPNOP; // Pipeline delay

    // Step 9: Write the new value to the input register
    TTI_SFPMUL(ckernel::p_sfpu::LCONST_1, ckernel::p_sfpu::LREG7, ckernel::p_sfpu::LCONST_0, ckernel::p_sfpu::LREG2, 0);
    ...
    // LREG7 = (LREG6 * LREG3) + LREG7 = (1-α) * input + α * EMA_old
    TTI_SFPMAD(ckernel::p_sfpu::LREG6, ckernel::p_sfpu::LREG3, ckernel::p_sfpu::LREG7, ckernel::p_sfpu::LREG7, 0);
    // Next cycle cannot read from LREG7 (2-cycle operation)

    TTI_SFPNOP; // Pipeline delay

    // Step 12: Write the new value to the input register
    TTI_SFPMUL(ckernel::p_sfpu::LCONST_1, ckernel::p_sfpu::LREG7, ckernel::p_sfpu::LCONST_0, ckernel::p_sfpu::LREG3, 0);
