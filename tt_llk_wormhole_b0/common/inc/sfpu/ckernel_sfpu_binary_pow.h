...
sfpi_inline sfpi::vFloat _sfpu_binary_power_21f_(sfpi::vFloat base, sfpi::vFloat pow)
{
    ...
    { // negative base
        ...
        { // negative base and non-integer power => set to NaN
...
sfpi_inline sfpi::vFloat _sfpu_binary_power_61f_(sfpi::vFloat base, sfpi::vFloat pow)
{
    ...
    sfpi::vFloat series_result = x * (x * (x * (x * (x * 0.03101577f - 0.28807408f) + 1.1286426f) - 2.45830873f) + 3.5271965f) - 1.94046315f;
    ...
    sfpi::vFloat poly =
        ((((((0.0002170391f * frac) + 0.001243946f) * frac + 0.0096788315f) * frac + 0.055483369f) * frac + 0.24022982f) * frac + 0.69314699f) * frac +
        1.0000000018f;
...
inline void _calculate_sfpu_binary_pow_(const uint dst_index_in0, const uint dst_index_in1, const uint dst_index_out)
{
...
inline void _sfpu_binary_pow_init_()
{
