...
sfpi_inline void _calculate_log_body_(const uint32_t log_base_scale_factor, const uint32_t dst_idx = 0)
{
...
inline void _calculate_log_(const int iterations, uint32_t log_base_scale_factor)
{
#pragma GCC unroll 8
