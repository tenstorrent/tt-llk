...
#define TT_APOOL3S1(clear_dvalid, addr_mode, index_en, dst)  TT_INSN(false, TT_OP_APOOL3S1(clear_dvalid, addr_mode, index_en, dst))
#define TTI_APOOL3S1(clear_dvalid, addr_mode, index_en, dst) TTI_INSN(false, TT_OP_APOOL3S1(clear_dvalid, addr_mode, index_en, dst))
...
#define TT_APOOL3S2_VALID(clear_dvalid, addr_mode, index_en, dst) \
    (ckernel::is_valid(clear_dvalid, 2) && ckernel::is_valid(addr_mode, 7) && ckernel::is_valid(index_en, 1) && ckernel::is_valid(dst, 14))
#define TT_APOOL3S2(clear_dvalid, addr_mode, index_en, dst)  TT_INSN(false, TT_OP_APOOL3S2(clear_dvalid, addr_mode, index_en, dst))
#define TTI_APOOL3S2(clear_dvalid, addr_mode, index_en, dst) TTI_INSN(false, TT_OP_APOOL3S2(clear_dvalid, addr_mode, index_en, dst))
...
#define TT_GAPOOL(clear_dvalid, instr_mod19, addr_mode, max_pool_index_en, dst) \
    TT_INSN(false, TT_OP_GAPOOL(clear_dvalid, instr_mod19, addr_mode, max_pool_index_en, dst))
#define TTI_GAPOOL(clear_dvalid, instr_mod19, addr_mode, max_pool_index_en, dst) \
    TTI_INSN(false, TT_OP_GAPOOL(clear_dvalid, instr_mod19, addr_mode, max_pool_index_en, dst))
...
#define TT_GMPOOL(clear_dvalid, instr_mod19, addr_mode, max_pool_index_en, dst) \
    TT_INSN(false, TT_OP_GMPOOL(clear_dvalid, instr_mod19, addr_mode, max_pool_index_en, dst))
#define TTI_GMPOOL(clear_dvalid, instr_mod19, addr_mode, max_pool_index_en, dst) \
    TTI_INSN(false, TT_OP_GMPOOL(clear_dvalid, instr_mod19, addr_mode, max_pool_index_en, dst))
...
#define TT_MOP(mop_type, loop_count, zmask_lo16)       TT_INSN(false, TT_OP_MOP(mop_type, loop_count, zmask_lo16))
#define TTI_MOP(mop_type, loop_count, zmask_lo16)      TTI_INSN(false, TT_OP_MOP(mop_type, loop_count, zmask_lo16))
...
#define TT_MOVB2D_VALID(dest_32b_lo, src, addr_mode, instr_mod, dst)                                                                         \
    (ckernel::is_valid(dest_32b_lo, 1) && ckernel::is_valid(src, 6) && ckernel::is_valid(addr_mode, 2) && ckernel::is_valid(instr_mod, 3) && \
     ckernel::is_valid(dst, 12))
#define TT_MOVB2D(dest_32b_lo, src, addr_mode, instr_mod, dst)  TT_INSN(false, TT_OP_MOVB2D(dest_32b_lo, src, addr_mode, instr_mod, dst))
#define TTI_MOVB2D(dest_32b_lo, src, addr_mode, instr_mod, dst) TTI_INSN(false, TT_OP_MOVB2D(dest_32b_lo, src, addr_mode, instr_mod, dst))
...
#define TT_MPOOL3S1_VALID(clear_dvalid, addr_mode, index_en, dst) \
    (ckernel::is_valid(clear_dvalid, 2) && ckernel::is_valid(addr_mode, 7) && ckernel::is_valid(index_en, 1) && ckernel::is_valid(dst, 14))
#define TT_MPOOL3S1(clear_dvalid, addr_mode, index_en, dst)  TT_INSN(false, TT_OP_MPOOL3S1(clear_dvalid, addr_mode, index_en, dst))
#define TTI_MPOOL3S1(clear_dvalid, addr_mode, index_en, dst) TTI_INSN(false, TT_OP_MPOOL3S1(clear_dvalid, addr_mode, index_en, dst))
...
#define TT_MPOOL3S2_VALID(clear_dvalid, addr_mode, index_en, dst) \
    (ckernel::is_valid(clear_dvalid, 2) && ckernel::is_valid(addr_mode, 7) && ckernel::is_valid(index_en, 1) && ckernel::is_valid(dst, 14))
#define TT_MPOOL3S2(clear_dvalid, addr_mode, index_en, dst)  TT_INSN(false, TT_OP_MPOOL3S2(clear_dvalid, addr_mode, index_en, dst))
#define TTI_MPOOL3S2(clear_dvalid, addr_mode, index_en, dst) TTI_INSN(false, TT_OP_MPOOL3S2(clear_dvalid, addr_mode, index_en, dst))
...
#define TT_PACR(AddrMode, ZeroWrite, PackSel, OvrdThreadId, Concat, Flush, Last) \
    TT_INSN(false, TT_OP_PACR(AddrMode, ZeroWrite, PackSel, OvrdThreadId, Concat, Flush, Last))
#define TTI_PACR(AddrMode, ZeroWrite, PackSel, OvrdThreadId, Concat, Flush, Last) \
    TTI_INSN(false, TT_OP_PACR(AddrMode, ZeroWrite, PackSel, OvrdThreadId, Concat, Flush, Last))
...
#define TT_PACR_SETREG(Push, AddrSel, WrData, PackSel, StreamId, Flush, Last) \
    TT_INSN(false, TT_OP_PACR_SETREG(Push, AddrSel, WrData, PackSel, StreamId, Flush, Last))
#define TTI_PACR_SETREG(Push, AddrSel, WrData, PackSel, StreamId, Flush, Last) \
    TTI_INSN(false, TT_OP_PACR_SETREG(Push, AddrSel, WrData, PackSel, StreamId, Flush, Last))
...
#define TT_UNPACR_NOP(Unpack_block_selection, NoOp)       TT_INSN(false, TT_OP_UNPACR_NOP(Unpack_block_selection, NoOp))
#define TTI_UNPACR_NOP(Unpack_block_selection, NoOp)      TTI_INSN(false, TT_OP_UNPACR_NOP(Unpack_block_selection, NoOp))
...
#define TT_ZEROACC(clear_mode, AddrMode, dst)       TT_INSN(false, TT_OP_ZEROACC(clear_mode, AddrMode, dst))
#define TTI_ZEROACC(clear_mode, AddrMode, dst)      TTI_INSN(false, TT_OP_ZEROACC(clear_mode, AddrMode, dst))
