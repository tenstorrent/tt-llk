...
inline void _llk_unpack_AB_mop_config_(
    ...
    if constexpr (BType == BroadcastType::COL) {
        ...
        static constexpr std::uint32_tunpack_srcb_no_z_inc =
        ...
        if (transpose_of_faces) {
            static constexpr std::uint32_tsrca_set_z = TT_OP_SETADCZW(0b001, 0, 0, 0, 1, 0b0001); // set z to 1
            static constexpr std::uint32_tunpack_srca_skip_z =
