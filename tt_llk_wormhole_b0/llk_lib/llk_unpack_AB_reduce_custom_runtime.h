...
inline void _llk_unpack_AB_reduce_block_max_row_mop_config_runtime_(uint32_t block_ct_dim, bool respect_trigger = false)
{
...
inline void _llk_unpack_AB_reduce_block_max_row_init_runtime_(uint32_t block_ct_dim, bool respect_trigger = false)
{
 ...
 */
inline void _llk_unpack_AB_reduce_block_max_row_uninit_runtime_(const std::uint32_t unpA_face_r_dim, const std::uint32_t unpB_face_r_dim, bool respect_trigger = false)
{
