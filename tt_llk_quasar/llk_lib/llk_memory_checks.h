...
// Memory layout constants based on memory.quasar.ld
// L1 Layout:
// TRISC0_CODE:             0x0     - 0x4000  (16KB)
// TRISC0_LOADER_INIT_MEM:  0x4000  - 0x5000  (4KB)
// TRISC1_CODE:             0x5000  - 0x9000  (16KB)
// TRISC1_LOADER_INIT_MEM:  0x9000  - 0x9800  (2KB)
// TRISC2_CODE:             0x9800  - 0xD800  (16KB)
// TRISC2_LOADER_INIT_MEM:  0xD800  - 0xE000  (2KB)
// TRISC3_CODE:             0xE000  - 0x12000 (16KB)
// TRISC3_LOADER_INIT_MEM:  0x12000 - 0x13000 (4KB)
// Firmware End:            0x13000 (76KB)
// RUNTIME_ARGS:            0x64000 - 0x64400 (1KB)
// L1 End:                  0x16E000 (1464KB total L1)

constexpr std::uint32_t L1_FIRMWARE_END     = 0x13000;
 ...
 * @return Transformed address (divided by 16)
 */
 ...
 * @return true if address is in Region 1 (0x13000 - 0x64000)
 */
