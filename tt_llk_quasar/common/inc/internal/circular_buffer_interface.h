...
constexpr static uint32_t NUM_CIRCULAR_BUFFERS                          = 32;
constexpr static uint32_t UINT32_WORDS_PER_LOCAL_CIRCULAR_BUFFER_CONFIG = 4;
constexpr static uint32_t CIRCULAR_BUFFER_COMPUTE_ADDR_SHIFT            = 4;
