...
#define TTI_BITWOPGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    INSTRUCTION_WORD(TT_OP_BITWOPGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex))
...
#define TTI_CMPGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    INSTRUCTION_WORD(TT_OP_CMPGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex))
...
#define TTI_SETGPR(Payload_SigSelSize, Payload_SigSel, SetSignalsMode, RegIndex16b) \
    INSTRUCTION_WORD(TT_OP_SETGPR(Payload_SigSelSize, Payload_SigSel, SetSignalsMode, RegIndex16b))
...
#define TTI_SFPLOADMACRO(lreg_ind, instr_mod0, sfpu_addr_mode, done, dest_reg_addr) \
    INSTRUCTION_WORD(TT_OP_SFPLOADMACRO(lreg_ind, instr_mod0, sfpu_addr_mode, done, dest_reg_addr))
...
#define TTI_SHIFTGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    INSTRUCTION_WORD(TT_OP_SHIFTGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex))
...
#define TTI_STOREIND(SizeSel, MemSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex) \
    INSTRUCTION_WORD(TT_OP_STOREIND(SizeSel, MemSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex))
...
#define TTI_UNPACR_NOP(Unpacker_Select, Set_Dvalid, Stall_Clr_Cntrl, Bank_Clr_Ctrl, Src_ClrVal_Ctrl, Nop_type) \
    INSTRUCTION_WORD(TT_OP_UNPACR_NOP(Unpacker_Select, Set_Dvalid, Stall_Clr_Cntrl, Bank_Clr_Ctrl, Src_ClrVal_Ctrl, Nop_type))
