...
#define TT_ADDGPR(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TT_INSN(false, TT_OP_ADDGPR(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex))
#define TTI_ADDGPR(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TTI_INSN(false, TT_OP_ADDGPR(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex))
...
#define TT_ATCAS(MemHierSel, SwapVal, CmpVal, Sel32b, DataRegIndex, AddrRegIndex) \
    TT_INSN(false, TT_OP_ATCAS(MemHierSel, SwapVal, CmpVal, Sel32b, DataRegIndex, AddrRegIndex))
#define TTI_ATCAS(MemHierSel, SwapVal, CmpVal, Sel32b, DataRegIndex, AddrRegIndex) \
    TTI_INSN(false, TT_OP_ATCAS(MemHierSel, SwapVal, CmpVal, Sel32b, DataRegIndex, AddrRegIndex))
#define TT_OP_ATGETM(mutex_index) TT_OP(0xa0, (((mutex_index) << 0)))
#define TT_ATGETM(mutex_index)    TT_INSN(false, TT_OP_ATGETM(mutex_index))
#define TTI_ATGETM(mutex_index)   TTI_INSN(false, TT_OP_ATGETM(mutex_index))
...
#define TT_ATINCGET(MemHierSel, WrapVal, Sel32b, DataRegIndex, AddrRegIndex) \
    TT_INSN(false, TT_OP_ATINCGET(MemHierSel, WrapVal, Sel32b, DataRegIndex, AddrRegIndex))
#define TTI_ATINCGET(MemHierSel, WrapVal, Sel32b, DataRegIndex, AddrRegIndex) \
    TTI_INSN(false, TT_OP_ATINCGET(MemHierSel, WrapVal, Sel32b, DataRegIndex, AddrRegIndex))
...
#define TT_ATINCGETPTR(MemHierSel, NoIncr, IncrVal, WrapVal, Sel32b, DataRegIndex, AddrRegIndex) \
    TT_INSN(false, TT_OP_ATINCGETPTR(MemHierSel, NoIncr, IncrVal, WrapVal, Sel32b, DataRegIndex, AddrRegIndex))
#define TTI_ATINCGETPTR(MemHierSel, NoIncr, IncrVal, WrapVal, Sel32b, DataRegIndex, AddrRegIndex) \
    TTI_INSN(false, TT_OP_ATINCGETPTR(MemHierSel, NoIncr, IncrVal, WrapVal, Sel32b, DataRegIndex, AddrRegIndex))
#define TT_OP_ATRELM(mutex_index) TT_OP(0xa1, (((mutex_index) << 0)))
#define TT_ATRELM(mutex_index)    TT_INSN(false, TT_OP_ATRELM(mutex_index))
#define TTI_ATRELM(mutex_index)   TTI_INSN(false, TT_OP_ATRELM(mutex_index))
...
#define TT_ATSWAP(MemHierSel, SwapMask, DataRegIndex, AddrRegIndex) TT_INSN(false, TT_OP_ATSWAP(MemHierSel, SwapMask, DataRegIndex, AddrRegIndex))
#define TTI_ATSWAP(MemHierSel, SwapMask, DataRegIndex, AddrRegIndex) \
    TTI_INSN(false, TT_OP_ATSWAP(MemHierSel, SwapMask, DataRegIndex, AddrRegIndex))
...
#define TT_BITWOPGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TT_INSN(false, TT_OP_BITWOPGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex))
#define TTI_BITWOPGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TTI_INSN(false, TT_OP_BITWOPGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex))
...
#define TT_CFGSHIFTMASK(CfgRegAddr, disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel) \
    TT_INSN(false, TT_OP_CFGSHIFTMASK(CfgRegAddr, disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel))
#define TTI_CFGSHIFTMASK(CfgRegAddr, disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel) \
    TTI_INSN(false, TT_OP_CFGSHIFTMASK(CfgRegAddr, disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel))
...
#define TT_CFGSHIFTMASK_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(                            \
    CfgRegAddr, disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel)         \
    TT_INSN(false, TT_OP_CFGSHIFTMASK_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE( \
                CfgRegAddr, disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel))
#define TTI_CFGSHIFTMASK_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(                                 \
    CfgRegAddr, disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel)               \
    TTI_INSN(false, TT_OP_CFGSHIFTMASK_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE( \
        CfgRegAddr, disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel))
...
#define TT_CLEARDVALID(cleardvalid, cleardvalid_S, dest_dvalid_reset, dest_dvalid_client_bank_reset, dest_pulse_last, reset) \
    TT_INSN(false, TT_OP_CLEARDVALID(cleardvalid, cleardvalid_S, dest_dvalid_reset, dest_dvalid_client_bank_reset, dest_pulse_last, reset))
#define TTI_CLEARDVALID(cleardvalid, cleardvalid_S, dest_dvalid_reset, dest_dvalid_client_bank_reset, dest_pulse_last, reset) \
    TTI_INSN(false, TT_OP_CLEARDVALID(cleardvalid, cleardvalid_S, dest_dvalid_reset, dest_dvalid_client_bank_reset, dest_pulse_last, reset))
...
#define TT_CMPGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TT_INSN(false, TT_OP_CMPGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex))
#define TTI_CMPGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TTI_INSN(false, TT_OP_CMPGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex))
#define TT_OP_COMMIT_SHADOW(force_commit) TT_OP(0x41, (((force_commit) << 0)))
#define TT_COMMIT_SHADOW(force_commit)    TT_INSN(false, TT_OP_COMMIT_SHADOW(force_commit))
#define TTI_COMMIT_SHADOW(force_commit)   TTI_INSN(false, TT_OP_COMMIT_SHADOW(force_commit))
#define TT_OP_DMANOP                      TT_OP(0x60, 0)
#define TT_DMANOP                         TT_INSN(false, TT_OP_DMANOP
#define TTI_DMANOP                        TTI_INSN(false, TT_OP_DMANOP)
...
#define TT_ELWADD(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst) \
    TT_INSN(false, TT_OP_ELWADD(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst))
#define TTI_ELWADD(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst) \
    TTI_INSN(false, TT_OP_ELWADD(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst))
...
#define TT_ELWADDDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst) \
    TT_INSN(false, TT_OP_ELWADDDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst))
#define TTI_ELWADDDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst) \
    TTI_INSN(false, TT_OP_ELWADDDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst))
...
#define TT_ELWMUL(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst) \
    TT_INSN(false, TT_OP_ELWMUL(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst))
#define TTI_ELWMUL(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst) \
    TTI_INSN(false, TT_OP_ELWMUL(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst))
...
#define TT_ELWMULDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst) \
    TT_INSN(false, TT_OP_ELWMULDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst))
#define TTI_ELWMULDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst) \
    TTI_INSN(false, TT_OP_ELWMULDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst))
...
#define TT_ELWSUB(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst) \
    TT_INSN(false, TT_OP_ELWSUB(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst))
#define TTI_ELWSUB(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst) \
    TTI_INSN(false, TT_OP_ELWSUB(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst))
...
#define TT_ELWSUBDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst) \
    TT_INSN(false, TT_OP_ELWSUBDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst))
#define TTI_ELWSUBDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst) \
    TTI_INSN(false, TT_OP_ELWSUBDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst))
...
#define TT_GAPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst) \
    TT_INSN(false, TT_OP_GAPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst))
#define TTI_GAPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst) \
    TTI_INSN(false, TT_OP_GAPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst))
...
#define TT_GMPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst) \
    TT_INSN(false, TT_OP_GMPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst))
#define TTI_GMPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst) \
    TTI_INSN(false, TT_OP_GMPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst))
#define TT_OP_HALT                                                           TT_OP(0x23, 0)
#define TT_HALT                                                              TT_INSN(false, TT_OP_HALT
#define TTI_HALT                                                             TTI_INSN(false, TT_OP_HALT)
#define TT_OP_INCRWC(rwc_cr, rwc_a, rwc_b, rwc_d)                            TT_OP(0x38, (((rwc_cr) << 18) + ((rwc_a) << 13) + ((rwc_b) << 8) + ((rwc_d) << 0)))
#define TT_INCRWC(rwc_cr, rwc_a, rwc_b, rwc_d)                               TT_INSN(false, TT_OP_INCRWC(rwc_cr, rwc_a, rwc_b, rwc_d))
#define TTI_INCRWC(rwc_cr, rwc_a, rwc_b, rwc_d)                              TTI_INSN(false, TT_OP_INCRWC(rwc_cr, rwc_a, rwc_b, rwc_d))
...
#define TT_INC_DST_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value) \
    TT_INSN(false, TT_OP_INC_DST_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value))
#define TTI_INC_DST_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value) \
    TTI_INSN(false, TT_OP_INC_DST_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value))
...
#define TT_INC_SRC_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value) \
    TT_INSN(false, TT_OP_INC_SRC_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value))
#define TTI_INC_SRC_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value) \
    TTI_INSN(false, TT_OP_INC_SRC_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value))
...
#define TT_LOADIND(SizeSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex) \
    TT_INSN(false, TT_OP_LOADIND(SizeSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex))
#define TTI_LOADIND(SizeSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex) \
    TTI_INSN(false, TT_OP_LOADIND(SizeSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex))
#define TT_OP_LOADREG(TdmaDataRegIndex, RegAddr) TT_OP(0x68, (((TdmaDataRegIndex) << 18) + ((RegAddr) << 0)))
#define TT_LOADREG(TdmaDataRegIndex, RegAddr)    TT_INSN(false, TT_OP_LOADREG(TdmaDataRegIndex, RegAddr))
#define TTI_LOADREG(TdmaDataRegIndex, RegAddr)   TTI_INSN(false, TT_OP_LOADREG(TdmaDataRegIndex, RegAddr))
...
#define TT_MOP(mop_type, done, loop_count, zmask_lo8_or_loop_count) TT_INSN(false, TT_OP_MOP(mop_type, done, loop_count, zmask_lo8_or_loop_count))
#define TTI_MOP(mop_type, done, loop_count, zmask_lo8_or_loop_count) \
    TTI_INSN(false, TT_OP_MOP(mop_type, done, loop_count, zmask_lo8_or_loop_count))
#define TT_OP_MOP_CFG(zmask_hi24) TT_OP(0x03, (((zmask_hi24) << 0)))
#define TT_MOP_CFG(zmask_hi24)    TT_INSN(false, TT_OP_MOP_CFG(zmask_hi24))
#define TTI_MOP_CFG(zmask_hi24)   TTI_INSN(false, TT_OP_MOP_CFG(zmask_hi24))
...
#define TT_MOVA2D(dest_32b_lo, src, addr_mode, instr_mod, dst)  TT_INSN(false, TT_OP_MOVA2D(dest_32b_lo, src, addr_mode, instr_mod, dst))
#define TTI_MOVA2D(dest_32b_lo, src, addr_mode, instr_mod, dst) TTI_INSN(false, TT_OP_MOVA2D(dest_32b_lo, src, addr_mode, instr_mod, dst))
#define TT_OP_MOVB2A(srca, addr_mode, instr_mod, srcb)          TT_OP(0x0b, (((srca) << 17) + ((addr_mode) << 14) + ((instr_mod) << 12) + ((srcb) << 0)))
#define TT_MOVB2A(srca, addr_mode, instr_mod, srcb)             TT_INSN(false, TT_OP_MOVB2A(srca, addr_mode, instr_mod, srcb))
#define TTI_MOVB2A(srca, addr_mode, instr_mod, srcb)            TTI_INSN(false, TT_OP_MOVB2A(srca, addr_mode, instr_mod, srcb))
...
#define TT_MOVB2D(dest_32b_lo, src, addr_mode, transfer_sz, bcast_datum0, dst) \
    TT_INSN(false, TT_OP_MOVB2D(dest_32b_lo, src, addr_mode, transfer_sz, bcast_datum0, dst))
#define TTI_MOVB2D(dest_32b_lo, src, addr_mode, transfer_sz, bcast_datum0, dst) \
    TTI_INSN(false, TT_OP_MOVB2D(dest_32b_lo, src, addr_mode, transfer_sz, bcast_datum0, dst))
...
#define TT_MOVD2A(dest_32b_lo, src, addr_mode, instr_mod, dst)  TT_INSN(false, TT_OP_MOVD2A(dest_32b_lo, src, addr_mode, instr_mod, dst))
#define TTI_MOVD2A(dest_32b_lo, src, addr_mode, instr_mod, dst) TTI_INSN(false, TT_OP_MOVD2A(dest_32b_lo, src, addr_mode, instr_mod, dst))
...
#define TT_MOVD2B(dest_32b_lo, src, addr_mode, instr_mod, transpose, dst) \
    TT_INSN(false, TT_OP_MOVD2B(dest_32b_lo, src, addr_mode, instr_mod, transpose, dst))
#define TTI_MOVD2B(dest_32b_lo, src, addr_mode, instr_mod, transpose, dst) \
    TTI_INSN(false, TT_OP_MOVD2B(dest_32b_lo, src, addr_mode, instr_mod, transpose, dst))
...
#define TT_MOVDBGA2D(dest_32b_lo, src, addr_mode, instr_mod, dst) TT_INSN(false, TT_OP_MOVDBGA2D(dest_32b_lo, src, addr_mode, instr_mod, dst))
#define TTI_MOVDBGA2D(dest_32b_lo, src, addr_mode, instr_mod, dst) \
    TTI_INSN(false, TT_OP_MOVDBGA2D(dest_32b_lo, src, addr_mode, instr_mod, dst))
...
#define TT_MOVDBGB2D(dest_32b_lo, src, addr_mode, transfer_sz, bcast_datum0, dst) \
    TT_INSN(false, TT_OP_MOVDBGB2D(dest_32b_lo, src, addr_mode, transfer_sz, bcast_datum0, dst))
#define TTI_MOVDBGB2D(dest_32b_lo, src, addr_mode, transfer_sz, bcast_datum0, dst) \
    TTI_INSN(false, TT_OP_MOVDBGB2D(dest_32b_lo, src, addr_mode, transfer_sz, bcast_datum0, dst))
...
#define TT_MULGPR(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TT_INSN(false, TT_OP_MULGPR(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex))
#define TTI_MULGPR(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TTI_INSN(false, TT_OP_MULGPR(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex))
#define TT_OP_MVMUL(clear_dvalid, instr_mod19, addr_mode, dst) \
    TT_OP(0x26, (((clear_dvalid) << 22) + ((instr_mod19) << 19) + ((addr_mode) << 14) + ((dst) << 0)))
#define TT_MVMUL(clear_dvalid, instr_mod19, addr_mode, dst)  TT_INSN(false, TT_OP_MVMUL(clear_dvalid, instr_mod19, addr_mode, dst))
#define TTI_MVMUL(clear_dvalid, instr_mod19, addr_mode, dst) TTI_INSN(false, TT_OP_MVMUL(clear_dvalid, instr_mod19, addr_mode, dst))
...
#define TT_MVMULDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst) \
    TT_INSN(false, TT_OP_MVMULDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst))
#define TTI_MVMULDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst) \
    TTI_INSN(false, TT_OP_MVMULDI(clear_dvalid, ins_mod, srcb_addr, srca_addr, addr_mode, dst))
#define TT_OP_NOP TT_OP(0x02, 0)
#define TT_NOP    TT_INSN(false, TT_OP_NOP
#define TTI_NOP   TTI_INSN(false, TT_OP_NOP)
...
#define TT_PACR0_ROW(                                                                                                                                 \
    Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid) \
    TT_INSN(false, TT_OP_PACR0_ROW(                                                                                                      \
        Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid))
#define TTI_PACR0_ROW(                                                                                                                                \
    Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid) \
    TTI_INSN(false, TT_OP_PACR0_ROW(                                                                                                \
        Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid))
...
#define TT_PACR0_ROW_INC(                            \
    ...
    Buffer_Descriptor_Table_Sel,                     \
    ClrDatValid)                                     \
    TT_INSN(false, TT_OP_PACR0_ROW_INC( \
        Dst_Row_Idx_Inc,                             \
        Src_Row_Idx_Inc,                             \
        Dst_Face_Idx_Inc,                            \
        Src_Face_Idx_Inc,                            \
...
#define TTI_PACR0_ROW_INC(                                 \
    ...
    Buffer_Descriptor_Table_Sel,                           \
    ClrDatValid)                                           \
    TTI_INSN(false, TT_OP_PACR0_ROW_INC( \
        Dst_Row_Idx_Inc,                                   \
        Src_Row_Idx_Inc,                                   \
        Dst_Face_Idx_Inc,                                  \
        Src_Face_Idx_Inc,                                  \
...
#define TT_PACR0_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, ClrDatValid) \
    TT_INSN(false, TT_OP_PACR0_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, ClrDatValid))
#define TTI_PACR0_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, ClrDatValid) \
    TTI_INSN(false, TT_OP_PACR0_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, ClrDatValid))
...
#define TT_PACR0_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid) \
    TT_INSN(false, TT_OP_PACR0_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid))
#define TTI_PACR0_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid) \
    TTI_INSN(false, TT_OP_PACR0_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid))
...
#define TT_PACR1_ROW(                                                                                                                                 \
    Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid) \
    TT_INSN(false, TT_OP_PACR1_ROW(                                                                                                      \
        Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid))
#define TTI_PACR1_ROW(                                                                                                                                \
    Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid) \
    TTI_INSN(false, TT_OP_PACR1_ROW(                                                                                                \
        Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid))
...
#define TT_PACR1_ROW_INC(                            \
    ...
    Buffer_Descriptor_Table_Sel,                     \
    ClrDatValid)                                     \
    TT_INSN(false, TT_OP_PACR1_ROW_INC( \
        Dst_Row_Idx_Inc,                             \
        Src_Row_Idx_Inc,                             \
        Dst_Face_Idx_Inc,                            \
        Src_Face_Idx_Inc,                            \
...
#define TTI_PACR1_ROW_INC(                                 \
    ...
    Buffer_Descriptor_Table_Sel,                           \
    ClrDatValid)                                           \
    TTI_INSN(false, TT_OP_PACR1_ROW_INC( \
        Dst_Row_Idx_Inc,                                   \
        Src_Row_Idx_Inc,                                   \
        Dst_Face_Idx_Inc,                                  \
        Src_Face_Idx_Inc,                                  \
...
#define TT_PACR1_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, ClrDatValid) \
    TT_INSN(false, TT_OP_PACR1_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, ClrDatValid))
#define TTI_PACR1_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, ClrDatValid) \
    TTI_INSN(false, TT_OP_PACR1_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, ClrDatValid))
...
#define TT_PACR1_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid) \
    TT_INSN(false, TT_OP_PACR1_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid))
#define TTI_PACR1_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid) \
    TTI_INSN(false, TT_OP_PACR1_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, ClrDatValid))
...
#define TT_PACR_STRIDE(                            \
    ...
    PackerSel,                                     \
    ClrDatValid)                                   \
    TT_INSN(false, TT_OP_PACR_STRIDE( \
        Src_Row_Idx_or_Inc_Mul4,                   \
        Src_Row_Idx_Inc,                           \
        L1_Tile_Idx_or_Tile_Idx_Inc,               \
        Tile_Idx_Inc,                              \
...
#define TTI_PACR_STRIDE(                                 \
    ...
    PackerSel,                                           \
    ClrDatValid)                                         \
    TTI_INSN(false, TT_OP_PACR_STRIDE( \
        Src_Row_Idx_or_Inc_Mul4,                         \
        Src_Row_Idx_Inc,                                 \
        L1_Tile_Idx_or_Tile_Idx_Inc,                     \
        Tile_Idx_Inc,                                    \
...
#define TT_POP_TILES(unpacker_rd_done_wait_mask, num_tiles, buffer_sel) \
    TT_INSN(false, TT_OP_POP_TILES(unpacker_rd_done_wait_mask, num_tiles, buffer_sel))
#define TTI_POP_TILES(unpacker_rd_done_wait_mask, num_tiles, buffer_sel) \
    TTI_INSN(false, TT_OP_POP_TILES(unpacker_rd_done_wait_mask, num_tiles, buffer_sel))
...
#define TT_PUSH_TILES(packer_wr_done_wait_mask, num_tiles, buffer_sel) \
    TT_INSN(false, TT_OP_PUSH_TILES(packer_wr_done_wait_mask, num_tiles, buffer_sel))
#define TTI_PUSH_TILES(packer_wr_done_wait_mask, num_tiles, buffer_sel) \
    TTI_INSN(false, TT_OP_PUSH_TILES(packer_wr_done_wait_mask, num_tiles, buffer_sel))
#define TT_OP_RDCFG(GprAddress, CfgReg) TT_OP(0xb1, (((GprAddress) << 16) + ((CfgReg) << 0)))
#define TT_RDCFG(GprAddress, CfgReg)    TT_INSN(false, TT_OP_RDCFG(GprAddress, CfgReg))
#define TTI_RDCFG(GprAddress, CfgReg)   TTI_INSN(false, TT_OP_RDCFG(GprAddress, CfgReg))
...
#define TT_REPLAY(start_idx, len, last, set_mutex, execute_while_loading, load_mode) \
    TT_INSN(false, TT_OP_REPLAY(start_idx, len, last, set_mutex, execute_while_loading, load_mode))
#define TTI_REPLAY(start_idx, len, last, set_mutex, execute_while_loading, load_mode) \
    TTI_INSN(false, TT_OP_REPLAY(start_idx, len, last, set_mutex, execute_while_loading, load_mode))
#define TT_OP_RESOURCEDECL(linger_time, resources, op_class) TT_OP(0x05, (((linger_time) << 15) + ((resources) << 5) + ((op_class) << 0)))
#define TT_RESOURCEDECL(linger_time, resources, op_class)    TT_INSN(false, TT_OP_RESOURCEDECL(linger_time, resources, op_class))
#define TTI_RESOURCEDECL(linger_time, resources, op_class)   TTI_INSN(false, TT_OP_RESOURCEDECL(linger_time, resources, op_class))
#define TT_OP_RMWCIB0(CfgRegAddr, Mask, Data)                TT_OP(0xb2, (((CfgRegAddr) << 16) + ((Mask) << 8) + ((Data) << 0)))
#define TT_RMWCIB0(CfgRegAddr, Mask, Data)                   TT_INSN(false, TT_OP_RMWCIB0(CfgRegAddr, Mask, Data))
#define TTI_RMWCIB0(CfgRegAddr, Mask, Data)                  TTI_INSN(false, TT_OP_RMWCIB0(CfgRegAddr, Mask, Data))
...
#define TT_RMWCIB0_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data) \
    TT_INSN(false, TT_OP_RMWCIB0_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data))
#define TTI_RMWCIB0_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data) \
    TTI_INSN(false, TT_OP_RMWCIB0_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data))
#define TT_OP_RMWCIB1(CfgRegAddr, Mask, Data) TT_OP(0xb4, (((CfgRegAddr) << 16) + ((Mask) << 8) + ((Data) << 0)))
#define TT_RMWCIB1(CfgRegAddr, Mask, Data)    TT_INSN(false, TT_OP_RMWCIB1(CfgRegAddr, Mask, Data))
#define TTI_RMWCIB1(CfgRegAddr, Mask, Data)   TTI_INSN(false, TT_OP_RMWCIB1(CfgRegAddr, Mask, Data))
...
#define TT_RMWCIB1_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data) \
    TT_INSN(false, TT_OP_RMWCIB1_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data))
#define TTI_RMWCIB1_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data) \
    TTI_INSN(false, TT_OP_RMWCIB1_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data))
#define TT_OP_RMWCIB2(CfgRegAddr, Mask, Data) TT_OP(0xb6, (((CfgRegAddr) << 16) + ((Mask) << 8) + ((Data) << 0)))
#define TT_RMWCIB2(CfgRegAddr, Mask, Data)    TT_INSN(false, TT_OP_RMWCIB2(CfgRegAddr, Mask, Data))
#define TTI_RMWCIB2(CfgRegAddr, Mask, Data)   TTI_INSN(false, TT_OP_RMWCIB2(CfgRegAddr, Mask, Data))
...
#define TT_RMWCIB2_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data) \
    TT_INSN(false, TT_OP_RMWCIB2_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data))
#define TTI_RMWCIB2_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data) \
    TTI_INSN(false, TT_OP_RMWCIB2_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data))
#define TT_OP_RMWCIB3(CfgRegAddr, Mask, Data) TT_OP(0xb8, (((CfgRegAddr) << 16) + ((Mask) << 8) + ((Data) << 0)))
#define TT_RMWCIB3(CfgRegAddr, Mask, Data)    TT_INSN(false, TT_OP_RMWCIB3(CfgRegAddr, Mask, Data))
#define TTI_RMWCIB3(CfgRegAddr, Mask, Data)   TTI_INSN(false, TT_OP_RMWCIB3(CfgRegAddr, Mask, Data))
...
#define TT_RMWCIB3_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data) \
    TT_INSN(false, TT_OP_RMWCIB3_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data))
#define TTI_RMWCIB3_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data) \
    TTI_INSN(false, TT_OP_RMWCIB3_BUT_ALIAS_BIT_8_OF_CFG_REG_ADDR_WITH_LSB_OF_OPCODE(CfgRegAddr, Mask, Data))
#define TT_OP_RV_PACR(reg_idx2, reg_idx1, reg_idx0)   TT_OP(0x35, (((reg_idx2) << 10) + ((reg_idx1) << 5) + ((reg_idx0) << 0)))
#define TT_RV_PACR(reg_idx2, reg_idx1, reg_idx0)      TT_INSN(false, TT_OP_RV_PACR(reg_idx2, reg_idx1, reg_idx0))
#define TTI_RV_PACR(reg_idx2, reg_idx1, reg_idx0)     TTI_INSN(false, TT_OP_RV_PACR(reg_idx2, reg_idx1, reg_idx0))
#define TT_OP_RV_UNPACR(reg_idx2, reg_idx1, reg_idx0) TT_OP(0x39, (((reg_idx2) << 10) + ((reg_idx1) << 5) + ((reg_idx0) << 0)))
#define TT_RV_UNPACR(reg_idx2, reg_idx1, reg_idx0)    TT_INSN(false, TT_OP_RV_UNPACR(reg_idx2, reg_idx1, reg_idx0))
#define TTI_RV_UNPACR(reg_idx2, reg_idx1, reg_idx0)   TTI_INSN(false, TT_OP_RV_UNPACR(reg_idx2, reg_idx1, reg_idx0))
...
#define TT_SEMGET(sem_bank_sel, sem_sel)    TT_INSN(false, TT_OP_SEMGET(sem_bank_sel, sem_sel))
#define TTI_SEMGET(sem_bank_sel, sem_sel)   TTI_INSN(false, TT_OP_SEMGET(sem_bank_sel, sem_sel))
...
#define TT_SEMINIT(max_value, init_value, sem_bank_sel, sem_sel) TT_INSN(false, TT_OP_SEMINIT(max_value, init_value, sem_bank_sel, sem_sel))
#define TTI_SEMINIT(max_value, init_value, sem_bank_sel, sem_sel) \
    TTI_INSN(false, TT_OP_SEMINIT(max_value, init_value, sem_bank_sel, sem_sel))
#define TT_OP_SEMPOST(sem_bank_sel, sem_sel) TT_OP(0xa4, (((sem_bank_sel) << 8) + ((sem_sel) << 0)))
#define TT_SEMPOST(sem_bank_sel, sem_sel)    TT_INSN(false, TT_OP_SEMPOST(sem_bank_sel, sem_sel))
#define TTI_SEMPOST(sem_bank_sel, sem_sel)   TTI_INSN(false, TT_OP_SEMPOST(sem_bank_sel, sem_sel))
...
#define TT_SEMWAIT(stall_res, wait_sem_cond, sem_bank_sel, sem_sel) TT_INSN(false, TT_OP_SEMWAIT(stall_res, wait_sem_cond, sem_bank_sel, sem_sel))
#define TTI_SEMWAIT(stall_res, wait_sem_cond, sem_bank_sel, sem_sel) \
    TTI_INSN(false, TT_OP_SEMWAIT(stall_res, wait_sem_cond, sem_bank_sel, sem_sel))
#define TT_OP_SETASHRMV(reg_mask2) TT_OP(0x1c, (((reg_mask2) << 0)))
#define TT_SETASHRMV(reg_mask2)    TT_INSN(false, TT_OP_SETASHRMV(reg_mask2))
#define TTI_SETASHRMV(reg_mask2)   TTI_INSN(false, TT_OP_SETASHRMV(reg_mask2))
#define TT_OP_SETDVALID(setvalid)  TT_OP(0x57, (((setvalid) << 0)))
#define TT_SETDVALID(setvalid)     TT_INSN(false, TT_OP_SETDVALID(setvalid))
#define TTI_SETDVALID(setvalid)    TTI_INSN(false, TT_OP_SETDVALID(setvalid))
...
#define TT_SETGPR(Payload_SigSelSize, Payload_SigSel, SetSignalsMode, RegIndex16b) \
    TT_INSN(false, TT_OP_SETGPR(Payload_SigSelSize, Payload_SigSel, SetSignalsMode, RegIndex16b))
#define TTI_SETGPR(Payload_SigSelSize, Payload_SigSel, SetSignalsMode, RegIndex16b) \
    TTI_INSN(false, TT_OP_SETGPR(Payload_SigSelSize, Payload_SigSel, SetSignalsMode, RegIndex16b))
#define TT_OP_SETRWC(clear_ab_vld, rwc_cr, rwc_val, BitMask)                 TT_OP(0x37, (((clear_ab_vld) << 22) + ((rwc_cr) << 18) + ((rwc_val) << 6) + ((BitMask) << 0)))
#define TT_SETRWC(clear_ab_vld, rwc_cr, rwc_val, BitMask)                    TT_INSN(false, TT_OP_SETRWC(clear_ab_vld, rwc_cr, rwc_val, BitMask))
#define TTI_SETRWC(clear_ab_vld, rwc_cr, rwc_val, BitMask)                   TTI_INSN(false, TT_OP_SETRWC(clear_ab_vld, rwc_cr, rwc_val, BitMask))
...
#define TT_SET_DST_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value) \
    TT_INSN(false, TT_OP_SET_DST_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value))
#define TTI_SET_DST_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value) \
    TTI_INSN(false, TT_OP_SET_DST_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value))
...
#define TT_SET_SRC_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value) \
    TT_INSN(false, TT_OP_SET_SRC_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value))
#define TTI_SET_SRC_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value) \
    TTI_INSN(false, TT_OP_SET_SRC_TILE_FACE_ROW_IDX(Tile_Face_Row_Sel, EngineSel, Value))
#define TT_OP_SFPABS(imm12_math, lreg_c, lreg_dest, instr_mod1) TT_OP(0x7d, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPABS(imm12_math, lreg_c, lreg_dest, instr_mod1)    TT_INSN(true, TT_OP_SFPABS(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPABS(imm12_math, lreg_c, lreg_dest, instr_mod1)   TTI_INSN(true, TT_OP_SFPABS(imm12_math, lreg_c, lreg_dest, instr_mod1))
...
#define TT_SFPADD(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) \
    TT_INSN(true, TT_OP_SFPADD(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1))
#define TTI_SFPADD(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) \
    TTI_INSN(true, TT_OP_SFPADD(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1))
#define TT_OP_SFPADDI(imm16_math, lreg_dest, instr_mod1)        TT_OP(0x75, (((imm16_math) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPADDI(imm16_math, lreg_dest, instr_mod1)           TT_INSN(true, TT_OP_SFPADDI(imm16_math, lreg_dest, instr_mod1))
#define TTI_SFPADDI(imm16_math, lreg_dest, instr_mod1)          TTI_INSN(true, TT_OP_SFPADDI(imm16_math, lreg_dest, instr_mod1))
#define TT_OP_SFPAND(imm12_math, lreg_c, lreg_dest, instr_mod1) TT_OP(0x7e, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPAND(imm12_math, lreg_c, lreg_dest, instr_mod1)    TT_INSN(true, TT_OP_SFPAND(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPAND(imm12_math, lreg_c, lreg_dest, instr_mod1)   TTI_INSN(true, TT_OP_SFPAND(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPARECIP(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    TT_OP(0x99, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPARECIP(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(true, TT_OP_SFPARECIP(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPARECIP(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPARECIP(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPCAST(lreg_src_c, lreg_dest, instr_mod1)         TT_OP(0x90, (((lreg_src_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPCAST(lreg_src_c, lreg_dest, instr_mod1)            TT_INSN(true, TT_OP_SFPCAST(lreg_src_c, lreg_dest, instr_mod1))
#define TTI_SFPCAST(lreg_src_c, lreg_dest, instr_mod1)           TTI_INSN(true, TT_OP_SFPCAST(lreg_src_c, lreg_dest, instr_mod1))
#define TT_OP_SFPCOMPC(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    TT_OP(0x8b, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPCOMPC(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(true, TT_OP_SFPCOMPC(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPCOMPC(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPCOMPC(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPCONFIG(imm16_math, config_dest, instr_mod1)    TT_OP(0x91, (((imm16_math) << 8) + ((config_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPCONFIG(imm16_math, config_dest, instr_mod1)       TT_INSN(true, TT_OP_SFPCONFIG(imm16_math, config_dest, instr_mod1))
#define TTI_SFPCONFIG(imm16_math, config_dest, instr_mod1)      TTI_INSN(true, TT_OP_SFPCONFIG(imm16_math, config_dest, instr_mod1))
#define TT_OP_SFPDIVP2(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    TT_OP(0x76, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPDIVP2(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(true, TT_OP_SFPDIVP2(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPDIVP2(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPDIVP2(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPENCC(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    TT_OP(0x8a, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPENCC(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(true, TT_OP_SFPENCC(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPENCC(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPENCC(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPEXEXP(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    TT_OP(0x77, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPEXEXP(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(true, TT_OP_SFPEXEXP(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPEXEXP(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPEXEXP(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPEXMAN(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    TT_OP(0x78, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPEXMAN(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(true, TT_OP_SFPEXMAN(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPEXMAN(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPEXMAN(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPGT(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_OP(0x97, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPGT(imm12_math, lreg_c, lreg_dest, instr_mod1)     TT_INSN(true, TT_OP_SFPGT(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPGT(imm12_math, lreg_c, lreg_dest, instr_mod1)    TTI_INSN(true, TT_OP_SFPGT(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPIADD(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    TT_OP(0x79, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPIADD(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(true, TT_OP_SFPIADD(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPIADD(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPIADD(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPLE(imm12_math, lreg_c, lreg_dest, instr_mod1) TT_OP(0x96, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPLE(imm12_math, lreg_c, lreg_dest, instr_mod1)    TT_INSN(true, TT_OP_SFPLE(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPLE(imm12_math, lreg_c, lreg_dest, instr_mod1)   TTI_INSN(true, TT_OP_SFPLE(imm12_math, lreg_c, lreg_dest, instr_mod1))
...
#define TT_SFPLOAD(lreg_ind, instr_mod0, sfpu_addr_mode, done, dest_reg_addr) \
    TT_INSN(true, TT_OP_SFPLOAD(lreg_ind, instr_mod0, sfpu_addr_mode, done, dest_reg_addr))
#define TTI_SFPLOAD(lreg_ind, instr_mod0, sfpu_addr_mode, done, dest_reg_addr) \
    TTI_INSN(true, TT_OP_SFPLOAD(lreg_ind, instr_mod0, sfpu_addr_mode, done, dest_reg_addr))
#define TT_OP_SFPLOADI(lreg_ind, instr_mod0, imm16) TT_OP(0x71, (((lreg_ind) << 20) + ((instr_mod0) << 16) + ((imm16) << 0)))
#define TT_SFPLOADI(lreg_ind, instr_mod0, imm16)    TT_INSN(true, TT_OP_SFPLOADI(lreg_ind, instr_mod0, imm16))
#define TTI_SFPLOADI(lreg_ind, instr_mod0, imm16)   TTI_INSN(true, TT_OP_SFPLOADI(lreg_ind, instr_mod0, imm16))
...
#define TT_SFPLOADMACRO(lreg_ind, instr_mod0, sfpu_addr_mode, done, dest_reg_addr) \
    TT_INSN(true, TT_OP_SFPLOADMACRO(lreg_ind, instr_mod0, sfpu_addr_mode, done, dest_reg_addr))
#define TTI_SFPLOADMACRO(lreg_ind, instr_mod0, sfpu_addr_mode, done, dest_reg_addr) \
    TTI_INSN(true, TT_OP_SFPLOADMACRO(lreg_ind, instr_mod0, sfpu_addr_mode, done, dest_reg_addr))
#define TT_OP_SFPLUT(lreg_ind, instr_mod0, dest_reg_addr)      TT_OP(0x73, (((lreg_ind) << 20) + ((instr_mod0) << 16) + ((dest_reg_addr) << 0)))
#define TT_SFPLUT(lreg_ind, instr_mod0, dest_reg_addr)         TT_INSN(true, TT_OP_SFPLUT(lreg_ind, instr_mod0, dest_reg_addr))
#define TTI_SFPLUT(lreg_ind, instr_mod0, dest_reg_addr)        TTI_INSN(true, TT_OP_SFPLUT(lreg_ind, instr_mod0, dest_reg_addr))
#define TT_OP_SFPLUTFP32(lreg_dest, instr_mod1)                TT_OP(0x95, (((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPLUTFP32(lreg_dest, instr_mod1)                   TT_INSN(true, TT_OP_SFPLUTFP32(lreg_dest, instr_mod1))
#define TTI_SFPLUTFP32(lreg_dest, instr_mod1)                  TTI_INSN(true, TT_OP_SFPLUTFP32(lreg_dest, instr_mod1))
#define TT_OP_SFPLZ(imm12_math, lreg_c, lreg_dest, instr_mod1) TT_OP(0x81, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPLZ(imm12_math, lreg_c, lreg_dest, instr_mod1)    TT_INSN(true, TT_OP_SFPLZ(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPLZ(imm12_math, lreg_c, lreg_dest, instr_mod1)   TTI_INSN(true, TT_OP_SFPLZ(imm12_math, lreg_c, lreg_dest, instr_mod1))
...
#define TT_SFPMAD(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) \
    TT_INSN(true, TT_OP_SFPMAD(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1))
#define TTI_SFPMAD(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) \
    TTI_INSN(true, TT_OP_SFPMAD(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1))
#define TT_OP_SFPMOV(imm12_math, lreg_c, lreg_dest, instr_mod1) TT_OP(0x7c, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPMOV(imm12_math, lreg_c, lreg_dest, instr_mod1)    TT_INSN(true, TT_OP_SFPMOV(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPMOV(imm12_math, lreg_c, lreg_dest, instr_mod1)   TTI_INSN(true, TT_OP_SFPMOV(imm12_math, lreg_c, lreg_dest, instr_mod1))
...
#define TT_SFPMUL(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) \
    TT_INSN(true, TT_OP_SFPMUL(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1))
#define TTI_SFPMUL(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) \
    TTI_INSN(true, TT_OP_SFPMUL(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1))
...
#define TT_SFPMUL24(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) \
    TT_INSN(true, TT_OP_SFPMUL24(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1))
#define TTI_SFPMUL24(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) \
    TTI_INSN(true, TT_OP_SFPMUL24(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1))
#define TT_OP_SFPMULI(imm16_math, lreg_dest, instr_mod1)        TT_OP(0x74, (((imm16_math) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPMULI(imm16_math, lreg_dest, instr_mod1)           TT_INSN(true, TT_OP_SFPMULI(imm16_math, lreg_dest, instr_mod1))
#define TTI_SFPMULI(imm16_math, lreg_dest, instr_mod1)          TTI_INSN(true, TT_OP_SFPMULI(imm16_math, lreg_dest, instr_mod1))
#define TT_OP_SFPNOP(srcs_wr_done, srcs_rd_done, dest_done)     TT_OP(0x8f, (((srcs_wr_done) << 2) + ((srcs_rd_done) << 1) + ((dest_done) << 0)))
#define TT_SFPNOP(srcs_wr_done, srcs_rd_done, dest_done)        TT_INSN(true, TT_OP_SFPNOP(srcs_wr_done, srcs_rd_done, dest_done))
#define TTI_SFPNOP(srcs_wr_done, srcs_rd_done, dest_done)       TTI_INSN(true, TT_OP_SFPNOP(srcs_wr_done, srcs_rd_done, dest_done))
#define TT_OP_SFPNOT(imm12_math, lreg_c, lreg_dest, instr_mod1) TT_OP(0x80, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPNOT(imm12_math, lreg_c, lreg_dest, instr_mod1)    TT_INSN(true, TT_OP_SFPNOT(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPNOT(imm12_math, lreg_c, lreg_dest, instr_mod1)   TTI_INSN(true, TT_OP_SFPNOT(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPOR(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_OP(0x7f, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPOR(imm12_math, lreg_c, lreg_dest, instr_mod1)     TT_INSN(true, TT_OP_SFPOR(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPOR(imm12_math, lreg_c, lreg_dest, instr_mod1)    TTI_INSN(true, TT_OP_SFPOR(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPPOPC(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    TT_OP(0x88, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPPOPC(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(true, TT_OP_SFPPOPC(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPPOPC(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPPOPC(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPPUSHC(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    TT_OP(0x87, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPPUSHC(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(true, TT_OP_SFPPUSHC(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPPUSHC(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPPUSHC(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPSETCC(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    TT_OP(0x7b, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPSETCC(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(true, TT_OP_SFPSETCC(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPSETCC(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPSETCC(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPSETEXP(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    TT_OP(0x82, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPSETEXP(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(true, TT_OP_SFPSETEXP(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPSETEXP(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPSETEXP(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPSETMAN(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    TT_OP(0x83, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPSETMAN(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(true, TT_OP_SFPSETMAN(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPSETMAN(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPSETMAN(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPSETSGN(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    TT_OP(0x89, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPSETSGN(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(true, TT_OP_SFPSETSGN(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPSETSGN(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPSETSGN(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPSHFT(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    TT_OP(0x7a, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPSHFT(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(true, TT_OP_SFPSHFT(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPSHFT(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPSHFT(imm12_math, lreg_c, lreg_dest, instr_mod1))
...
#define TT_SFPSHFT2(imm12_math, lreg_src_c, lreg_dest, instr_mod1) TT_INSN(true, TT_OP_SFPSHFT2(imm12_math, lreg_src_c, lreg_dest, instr_mod1))
#define TTI_SFPSHFT2(imm12_math, lreg_src_c, lreg_dest, instr_mod1) \
    TTI_INSN(true, TT_OP_SFPSHFT2(imm12_math, lreg_src_c, lreg_dest, instr_mod1))
...
#define TT_SFPSTORE(lreg_ind, instr_mod0, sfpu_addr_mode, done, dest_reg_addr) \
    TT_INSN(true, TT_OP_SFPSTORE(lreg_ind, instr_mod0, sfpu_addr_mode, done, dest_reg_addr))
#define TTI_SFPSTORE(lreg_ind, instr_mod0, sfpu_addr_mode, done, dest_reg_addr) \
    TTI_INSN(true, TT_OP_SFPSTORE(lreg_ind, instr_mod0, sfpu_addr_mode, done, dest_reg_addr))
...
#define TT_SFPSWAP(imm12_math, lreg_src_c, lreg_dest, instr_mod1) TT_INSN(true, TT_OP_SFPSWAP(imm12_math, lreg_src_c, lreg_dest, instr_mod1))
#define TTI_SFPSWAP(imm12_math, lreg_src_c, lreg_dest, instr_mod1) \
    TTI_INSN(true, TT_OP_SFPSWAP(imm12_math, lreg_src_c, lreg_dest, instr_mod1))
#define TT_OP_SFPTRANSP(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    TT_OP(0x8c, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPTRANSP(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(true, TT_OP_SFPTRANSP(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPTRANSP(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPTRANSP(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TT_OP_SFPXOR(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_OP(0x8d, (((imm12_math) << 12) + ((lreg_c) << 8) + ((lreg_dest) << 4) + ((instr_mod1) << 0)))
#define TT_SFPXOR(imm12_math, lreg_c, lreg_dest, instr_mod1)     TT_INSN(true, TT_OP_SFPXOR(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPXOR(imm12_math, lreg_c, lreg_dest, instr_mod1)    TTI_INSN(true, TT_OP_SFPXOR(imm12_math, lreg_c, lreg_dest, instr_mod1))
...
#define TT_SFP_STOCH_RND(rnd_mode, imm8_math, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) \
    TT_INSN(true, TT_OP_SFP_STOCH_RND(rnd_mode, imm8_math, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1))
#define TTI_SFP_STOCH_RND(rnd_mode, imm8_math, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) \
    TTI_INSN(true, TT_OP_SFP_STOCH_RND(rnd_mode, imm8_math, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1))
...
#define TT_SHIFTGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TT_INSN(false, TT_OP_SHIFTGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex))
#define TTI_SHIFTGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TTI_INSN(false, TT_OP_SHIFTGPR(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex))
#define TT_OP_SHIFTXA(log2_amount2, shift_mode)        TT_OP(0x17, (((log2_amount2) << 2) + ((shift_mode) << 0)))
#define TT_SHIFTXA(log2_amount2, shift_mode)           TT_INSN(false, TT_OP_SHIFTXA(log2_amount2, shift_mode))
#define TTI_SHIFTXA(log2_amount2, shift_mode)          TTI_INSN(false, TT_OP_SHIFTXA(log2_amount2, shift_mode))
#define TT_OP_SHIFTXB(addr_mode, rot_shift, shift_row) TT_OP(0x18, (((addr_mode) << 14) + ((rot_shift) << 10) + ((shift_row) << 0)))
#define TT_SHIFTXB(addr_mode, rot_shift, shift_row)    TT_INSN(false, TT_OP_SHIFTXB(addr_mode, rot_shift, shift_row))
#define TTI_SHIFTXB(addr_mode, rot_shift, shift_row)   TTI_INSN(false, TT_OP_SHIFTXB(addr_mode, rot_shift, shift_row))
...
#define TT_STALLWAIT(stall_res, wait_res_idx_2, wait_res_idx_1, wait_res_idx_0) \
    TT_INSN(false, TT_OP_STALLWAIT(stall_res, wait_res_idx_2, wait_res_idx_1, wait_res_idx_0))
#define TTI_STALLWAIT(stall_res, wait_res_idx_2, wait_res_idx_1, wait_res_idx_0) \
    TTI_INSN(false, TT_OP_STALLWAIT(stall_res, wait_res_idx_2, wait_res_idx_1, wait_res_idx_0))
...
#define TT_STOREIND(SizeSel, MemSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex) \
    TT_INSN(false, TT_OP_STOREIND(SizeSel, MemSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex))
#define TTI_STOREIND(SizeSel, MemSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex) \
    TTI_INSN(false, TT_OP_STOREIND(SizeSel, MemSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex))
#define TT_OP_STOREREG(TdmaDataRegIndex, RegAddr) TT_OP(0x67, (((TdmaDataRegIndex) << 18) + ((RegAddr) << 0)))
#define TT_STOREREG(TdmaDataRegIndex, RegAddr)    TT_INSN(false, TT_OP_STOREREG(TdmaDataRegIndex, RegAddr))
#define TTI_STOREREG(TdmaDataRegIndex, RegAddr)   TTI_INSN(false, TT_OP_STOREREG(TdmaDataRegIndex, RegAddr))
...
#define TT_SUBGPR(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TT_INSN(false, TT_OP_SUBGPR(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex))
#define TTI_SUBGPR(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TTI_INSN(false, TT_OP_SUBGPR(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex))
...
#define TTI_UNPACR0_FACE_INC(Dst_Face_Idx_Inc, Src_Face_Idx_Inc, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR0_FACE_INC(                                                                                                \
...
#define TT_UNPACR0_ROW(                                                                                                                               \
    Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR0_ROW(                                                                                                    \
        Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR0_ROW(                                                                                                                              \
    Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR0_ROW(                                                                                              \
        Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR0_ROW_INC(                            \
    ...
    Buffer_Descriptor_Table_Sel,                       \
    SetDatValid)                                       \
    TT_INSN(false, TT_OP_UNPACR0_ROW_INC( \
        Dst_Row_Idx_Inc,                               \
        Src_Row_Idx_Inc,                               \
        Dst_Face_Idx_Inc,                              \
        Src_Face_Idx_Inc,                              \
...
#define TTI_UNPACR0_ROW_INC(                                 \
    ...
    Buffer_Descriptor_Table_Sel,                             \
    SetDatValid)                                             \
    TTI_INSN(false, TT_OP_UNPACR0_ROW_INC( \
        Dst_Row_Idx_Inc,                                     \
        Src_Row_Idx_Inc,                                     \
        Dst_Face_Idx_Inc,                                    \
        Src_Face_Idx_Inc,                                    \
...
#define TT_UNPACR0_STRIDE(                                                                                                                             \
    Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR0_STRIDE(                                                                                                  \
        Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR0_STRIDE(                                                                                                                            \
    Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR0_STRIDE(                                                                                            \
        Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR0_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR0_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR0_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR0_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR0_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR0_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR0_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR0_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TTI_UNPACR1_FACE_INC(Dst_Face_Idx_Inc, Src_Face_Idx_Inc, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR1_FACE_INC(                                                                                                \
        Dst_Face_Idx_Inc, Src_Face_Idx_Inc, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR1_ROW(                                                                                                                               \
    Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR1_ROW(                                                                                                    \
        Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR1_ROW(                                                                                                                              \
    Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR1_ROW(                                                                                              \
        Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR1_ROW_INC(                            \
    ...
    Buffer_Descriptor_Table_Sel,                       \
    SetDatValid)                                       \
    TT_INSN(false, TT_OP_UNPACR1_ROW_INC( \
        Dst_Row_Idx_Inc,                               \
        Src_Row_Idx_Inc,                               \
        Dst_Face_Idx_Inc,                              \
        Src_Face_Idx_Inc,                              \
...
#define TTI_UNPACR1_ROW_INC(                                 \
    ...
    Buffer_Descriptor_Table_Sel,                             \
    SetDatValid)                                             \
    TTI_INSN(false, TT_OP_UNPACR1_ROW_INC( \
        Dst_Row_Idx_Inc,                                     \
        Src_Row_Idx_Inc,                                     \
        Dst_Face_Idx_Inc,                                    \
        Src_Face_Idx_Inc,                                    \
...
#define TT_UNPACR1_STRIDE(                                                                                                                             \
    Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR1_STRIDE(                                                                                                  \
        Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR1_STRIDE(                                                                                                                            \
    Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR1_STRIDE(                                                                                            \
        Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR1_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR1_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR1_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR1_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR1_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR1_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR1_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR1_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TTI_UNPACR2_FACE_INC(Dst_Face_Idx_Inc, Src_Face_Idx_Inc, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR2_FACE_INC(                                                                                                \
        Dst_Face_Idx_Inc, Src_Face_Idx_Inc, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR2_ROW(                                                                                                                               \
    Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR2_ROW(                                                                                                    \
        Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR2_ROW(                                                                                                                              \
    Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR2_ROW(                                                                                              \
        Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid)))
...
#define TT_UNPACR2_ROW_INC(                            \
    ...
    Buffer_Descriptor_Table_Sel,                       \
    SetDatValid)                                       \
    TT_INSN(false, TT_OP_UNPACR2_ROW_INC( \
        Dst_Row_Idx_Inc,                               \
        Src_Row_Idx_Inc,                               \
        Dst_Face_Idx_Inc,                              \
        Src_Face_Idx_Inc,                              \
...
#define TTI_UNPACR2_ROW_INC(                                 \
    ...
    Buffer_Descriptor_Table_Sel,                             \
    SetDatValid)                                             \
    TTI_INSN(false, TT_OP_UNPACR2_ROW_INC( \
        Dst_Row_Idx_Inc,                                     \
        Src_Row_Idx_Inc,                                     \
        Dst_Face_Idx_Inc,                                    \
        Src_Face_Idx_Inc,                                    \
...
#define TT_UNPACR2_STRIDE(                                                                                                                             \
    Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR2_STRIDE(                                                                                                  \
        Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR2_STRIDE(                                                                                                                            \
    Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR2_STRIDE(                                                                                            \
        Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR2_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR2_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR2_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR2_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR2_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR2_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR2_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR2_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR_DEST_FACE_INC(                                                                                                    \
    Dst_Face_Idx_Inc, Src_Face_Idx_Inc, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR_DEST_FACE_INC(                                                                         \
        Dst_Face_Idx_Inc, Src_Face_Idx_Inc, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR_DEST_FACE_INC(                                                                                                   \
    Dst_Face_Idx_Inc, Src_Face_Idx_Inc, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR_DEST_FACE_INC(                                                                   \
        Dst_Face_Idx_Inc, Src_Face_Idx_Inc, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR_DEST_ROW(                                                                                                                           \
    Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR_DEST_ROW(                                                                                                \
        Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR_DEST_ROW(                                                                                                                          \
    Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR_DEST_ROW(                                                                                          \
        Dst_Row_Idx, Src_Row_Idx, Dst_Face_Idx, Src_Face_Idx, Dst_Tile_Offset_Idx_Inc, Src_Tile_Offset_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR_DEST_ROW_INC(                            \
    ...
    Buffer_Descriptor_Table_Sel,                           \
    SetDatValid)                                           \
    TT_INSN(false, TT_OP_UNPACR_DEST_ROW_INC( \
        Dst_Row_Idx_Inc,                                   \
        Src_Row_Idx_Inc,                                   \
        Dst_Face_Idx_Inc,                                  \
        Src_Face_Idx_Inc,                                  \
...
#define TTI_UNPACR_DEST_ROW_INC(                                 \
    ...
    Buffer_Descriptor_Table_Sel,                                 \
    SetDatValid)                                                 \
    TTI_INSN(false, TT_OP_UNPACR_DEST_ROW_INC( \
        Dst_Row_Idx_Inc,                                         \
        Src_Row_Idx_Inc,                                         \
        Dst_Face_Idx_Inc,                                        \
        Src_Face_Idx_Inc,                                        \
...
#define TT_UNPACR_DEST_STRIDE(                                                                                                                         \
    Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR_DEST_STRIDE(                                                                                              \
        Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR_DEST_STRIDE(                                                                                                                        \
    Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR_DEST_STRIDE(                                                                                        \
        Src_Reg_Y_Cntr_Incr, L1_Tile_Idx_or_Tile_Idx_Inc, Tile_Idx_Inc, Row_Mask_Reg_Sel, L1_16datums_Row_Index, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR_DEST_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR_DEST_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR_DEST_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR_DEST_TILE(Dst_Tile_Idx, Src_Tile_Idx, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR_DEST_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TT_INSN(false, TT_OP_UNPACR_DEST_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
#define TTI_UNPACR_DEST_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid) \
    TTI_INSN(false, TT_OP_UNPACR_DEST_TILE_INC(Dst_Tile_Idx_Inc, Src_Tile_Idx_Inc, Buffer_Descriptor_Table_Sel, SetDatValid))
...
#define TT_UNPACR_NOP(Unpacker_Select, Set_Dvalid, Stall_Clr_Cntrl, Bank_Clr_Ctrl, Src_ClrVal_Ctrl, Nop_type) \
    TT_INSN(false, TT_OP_UNPACR_NOP(Unpacker_Select, Set_Dvalid, Stall_Clr_Cntrl, Bank_Clr_Ctrl, Src_ClrVal_Ctrl, Nop_type))
#define TTI_UNPACR_NOP(Unpacker_Select, Set_Dvalid, Stall_Clr_Cntrl, Bank_Clr_Ctrl, Src_ClrVal_Ctrl, Nop_type) \
    TTI_INSN(false, TT_OP_UNPACR_NOP(Unpacker_Select, Set_Dvalid, Stall_Clr_Cntrl, Bank_Clr_Ctrl, Src_ClrVal_Ctrl, Nop_type))
...
#define TT_WAIT_FREE(stall_res, num_tiles, buffer_sel)     TT_INSN(false, TT_OP_WAIT_FREE(stall_res, num_tiles, buffer_sel))
#define TTI_WAIT_FREE(stall_res, num_tiles, buffer_sel)    TTI_INSN(false, TT_OP_WAIT_FREE(stall_res, num_tiles, buffer_sel))
#define TT_OP_WAIT_TILES(stall_res, num_tiles, buffer_sel) TT_OP(0xa9, (((stall_res) << 15) + ((num_tiles) << 5) + ((buffer_sel) << 0)))
#define TT_WAIT_TILES(stall_res, num_tiles, buffer_sel)    TT_INSN(false, TT_OP_WAIT_TILES(stall_res, num_tiles, buffer_sel))
#define TTI_WAIT_TILES(stall_res, num_tiles, buffer_sel)   TTI_INSN(false, TT_OP_WAIT_TILES(stall_res, num_tiles, buffer_sel))
#define TT_OP_WRCFG(GprAddress, wr128b, CfgReg)            TT_OP(0xb0, (((GprAddress) << 16) + ((wr128b) << 15) + ((CfgReg) << 0)))
#define TT_WRCFG(GprAddress, wr128b, CfgReg)               TT_INSN(false, TT_OP_WRCFG(GprAddress, wr128b, CfgReg))
#define TTI_WRCFG(GprAddress, wr128b, CfgReg)              TTI_INSN(false, TT_OP_WRCFG(GprAddress, wr128b, CfgReg))
...
#define TT_ZEROACC(clear_mode, use_32_bit_mode, clear_zero_flags, addr_mode, where) \
    TT_INSN(false, TT_OP_ZEROACC(clear_mode, use_32_bit_mode, clear_zero_flags, addr_mode, where))
#define TTI_ZEROACC(clear_mode, use_32_bit_mode, clear_zero_flags, addr_mode, where) \
    TTI_INSN(false, TT_OP_ZEROACC(clear_mode, use_32_bit_mode, clear_zero_flags, addr_mode, where))
...
#define TT_ZEROSRC(packed_fmt, int_fmt, exp_bias, zero_val, write_mode, bank_mask, src_mask) \
    TT_INSN(false, TT_OP_ZEROSRC(packed_fmt, int_fmt, exp_bias, zero_val, write_mode, bank_mask, src_mask))
#define TTI_ZEROSRC(packed_fmt, int_fmt, exp_bias, zero_val, write_mode, bank_mask, src_mask) \
    TTI_INSN(false, TT_OP_ZEROSRC(packed_fmt, int_fmt, exp_bias, zero_val, write_mode, bank_mask, src_mask))

// lltt needs some of the above macros
#include "lltt.h"

#if defined (LLTT_INSN)
#define TTI_INSN(IS_SFP, ENCODING) LLTT_INSN(IS_SFP, ENCODING)
#define TT_INSN(IS_SFP, ENCODING) LLTT_INSN(IS_SFP, ENCODING)
#else
#define TTI_INSN(IS_SFP, ENCODING) __asm__ __volatile__(".ttinsn %0" : : "n"((ENCODING)))
#define TT_INSN(IS_SFP, ENCODING) (::ckernel::instrn_buffer[0] = (ENCODING)))
#endif
