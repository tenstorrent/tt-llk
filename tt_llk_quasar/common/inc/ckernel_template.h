...
inline void ckernel_template::program_and_run_and_finish()
{
    program();
    run_and_finish();
}
...
inline void ckernel_template::run_bank0_sw_cntl()
{
    TTI_MOP(1, 0, 0, 0); // run the double-loop template
}

inline void ckernel_template::run_and_finish()
{
    TTI_MOP(1, 1, 0, 0); // run the double-loop template
}

inline void ckernel_template::run_bank1_sw_cntl()
{
    TTI_MOP(1, 1, 0, 0); // run the double-loop template
}
...
inline void ckernel_template::program_bank0_sw_cntl()
{
    volatile mop_config_regs_t *mop_cfg = reinterpret_cast<volatile mop_config_regs_t *>(MOP_CFG_BASE);
...
inline void ckernel_template::program_bank1_sw_cntl()
{
    volatile mop_config_regs_t *mop_cfg = reinterpret_cast<volatile mop_config_regs_t *>(MOP_CFG_BASE);
