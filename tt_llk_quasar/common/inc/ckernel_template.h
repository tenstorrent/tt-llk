...
public:
    ...
    //EMC1 static constexpr std::uint32_t DEF_A_instr  = TT_OP_UNPACR(0,0b1, 0, 0, 0, 0, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    //EMC1 static constexpr std::uint32_t DEF_A_cntx_ovrd_instr  = TT_OP_UNPACR(0,0b1, 0, 0, 0, 1, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    static constexpr std::uint32_t DEF_A_instr  = TT_OP_UNPACR0(0,0b1, 0, 0, 0, 1, 0, 0, 0, 1);
    //EMC1 static constexpr std::uint32_t DEF_A_cntx_ovrd_instr  = TT_OP_UNPACR0(0,0b1, 0, 0, 1, 1, 0, 0, 0, 1);
    static constexpr std::uint32_t DEF_A_cntx_ovrd_instr  = TT_OP_UNPACR0(0,0b1, 0, 0, 0, 0, 0, 0, 0, 1);

    // Default B instruction with rarefy
    //EMC1 static constexpr std::uint32_t DEF_B_rarefy_instr = TT_OP_UNPACR(1, 0b01, 0, 0, 0, 0, 1, p_unpacr::RAREFYB_ENABLE, 0, 0, 0, 0, 1);
    //EMC1 static constexpr std::uint32_t DEF_B_rarefy_instr = TT_OP_UNPACR1(1, 0b01, 0, 0, 0, 1, 0, 0, 0, 1);

    // Default B instruction with rarefy and context override, coupled with halo on A
    //EMC1 static constexpr std::uint32_t DEF_B_rarefy_cntx_ovrd_instr = TT_OP_UNPACR(1, 0b01, 0, 0, 0, 1, 1, p_unpacr::RAREFYB_ENABLE, 0, 0, 0, 0, 1);
    //EMC1 static constexpr std::uint32_t DEF_B_rarefy_cntx_ovrd_instr = TT_OP_UNPACR1(1, 0b01, 0, 0, 1, 1, 0, 0, 0, 0, 1);

    // Default B instruction without rarefy, no z increment and with context override, coupled with halo on A for factored conv
    //EMC1 static constexpr std::uint32_t DEF_B_cntx_ovrd_no_z_inc_instr = TT_OP_UNPACR(1, 0b00, 0, 0, 0, 1, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    ...
    //EMC1 static constexpr std::uint32_t DEF_B_instr = TT_OP_UNPACR(1, 0b01, 0, 0, 0, 0, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    ...
    /*EMC1 static constexpr std::uint32_t DEF_A0_instr = TT_OP_UNPACR(0,0b00,0,p_unpacr::TILE0_CFG_CONTEXT,p_unpacr::TILE0_ADDRCNT_CONTEXT,1,0,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    static constexpr std::uint32_t DEF_A1_instr = TT_OP_UNPACR(0,0b00,0,p_unpacr::TILE1_CFG_CONTEXT,p_unpacr::TILE1_ADDRCNT_CONTEXT,1,0,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    static constexpr std::uint32_t DEF_A2_instr = TT_OP_UNPACR(0,0b00,0,p_unpacr::TILE2_CFG_CONTEXT,p_unpacr::TILE2_ADDRCNT_CONTEXT,1,0,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    static constexpr std::uint32_t DEF_A3_instr = TT_OP_UNPACR(0,0b01,0,p_unpacr::TILE3_CFG_CONTEXT,p_unpacr::TILE3_ADDRCNT_CONTEXT,1,1,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1); */
    ...
    /* EMC1
    static constexpr std::uint32_t DEF_A0_last_instr = TT_OP_UNPACR(0,0b01,0,p_unpacr::TILE0_CFG_CONTEXT,p_unpacr::TILE0_ADDRCNT_CONTEXT,1,1,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    static constexpr std::uint32_t DEF_A1_last_instr = TT_OP_UNPACR(0,0b01,0,p_unpacr::TILE1_CFG_CONTEXT,p_unpacr::TILE1_ADDRCNT_CONTEXT,1,1,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    static constexpr std::uint32_t DEF_A2_last_instr = TT_OP_UNPACR(0,0b01,0,p_unpacr::TILE2_CFG_CONTEXT,p_unpacr::TILE2_ADDRCNT_CONTEXT,1,1,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    */
    ...
    /* EMC1
    static constexpr std::uint32_t SKIP_A0_instr = TT_OP_UNPACR(0,0b00,1,p_unpacr::TILE0_CFG_CONTEXT,p_unpacr::TILE0_ADDRCNT_CONTEXT,1,0,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    static constexpr std::uint32_t SKIP_A1_instr = TT_OP_UNPACR(0,0b00,1,p_unpacr::TILE1_CFG_CONTEXT,p_unpacr::TILE1_ADDRCNT_CONTEXT,1,0,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    static constexpr std::uint32_t SKIP_A2_instr = TT_OP_UNPACR(0,0b00,1,p_unpacr::TILE2_CFG_CONTEXT,p_unpacr::TILE2_ADDRCNT_CONTEXT,1,0,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    static constexpr std::uint32_t SKIP_A3_instr = TT_OP_UNPACR(0,0b00,1,p_unpacr::TILE3_CFG_CONTEXT,p_unpacr::TILE3_ADDRCNT_CONTEXT,1,0,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    */
    ...
    /* EMC1
    static constexpr std::uint32_t DEF_A0_fconv_instr = TT_OP_UNPACR(0,0b00,0,p_unpacr::TILE0_CFG_CONTEXT,p_unpacr::TILE0_ADDRCNT_CONTEXT,1,0,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    static constexpr std::uint32_t DEF_A1_fconv_instr = TT_OP_UNPACR(0,0b00,0,p_unpacr::TILE1_CFG_CONTEXT,p_unpacr::TILE1_ADDRCNT_CONTEXT,1,0,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    static constexpr std::uint32_t DEF_A2_fconv_instr = TT_OP_UNPACR(0,0b00,0,p_unpacr::TILE2_CFG_CONTEXT,p_unpacr::TILE2_ADDRCNT_CONTEXT,1,0,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    static constexpr std::uint32_t DEF_A3_fconv_instr = TT_OP_UNPACR(0,0b00,0,p_unpacr::TILE3_CFG_CONTEXT,p_unpacr::TILE3_ADDRCNT_CONTEXT,1,1,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    */
    ...
    /* EMC1
    static constexpr std::uint32_t DEF_A0_fconv_last_instr = TT_OP_UNPACR(0,0b00,0,p_unpacr::TILE0_CFG_CONTEXT,p_unpacr::TILE0_ADDRCNT_CONTEXT,1,1,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    static constexpr std::uint32_t DEF_A1_fconv_last_instr = TT_OP_UNPACR(0,0b00,0,p_unpacr::TILE1_CFG_CONTEXT,p_unpacr::TILE1_ADDRCNT_CONTEXT,1,1,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    static constexpr std::uint32_t DEF_A2_fconv_last_instr = TT_OP_UNPACR(0,0b00,0,p_unpacr::TILE2_CFG_CONTEXT,p_unpacr::TILE2_ADDRCNT_CONTEXT,1,1,p_unpacr::RAREFYB_DISABLE, 0,p_unpacr::AUTO_INC_CONTEXT,1,0,1);
    */
    ...
    //EMC1 static constexpr std::uint32_t DEF_D_instr  = TT_OP_UNPACR(0, 0b10001, 0, 0, 0, 1, 0, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1); // unpack0 to dest, and increment Z for src-tile and dest
    ...
    //EMC1 static constexpr std::uint32_t DEF_D_cntx_ovrd_instr  = TT_OP_UNPACR(0, 0b10000, 0, 1, 0, 1, 0, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1); // unpack0 to dest using context 1
    ...
    //EMC1 static constexpr std::uint32_t DEF_D_auto_inc_cntx_instr0  = TT_OP_UNPACR(0, 0b00000, 0, 0, 0, 1, 0, p_unpacr::RAREFYB_DISABLE, 0, p_unpacr::AUTO_INC_CONTEXT, 0, 0, 1); // unpack0 to dest, and increment Z for src-tile and dest
    //EMC1 static constexpr std::uint32_t DEF_D_auto_inc_cntx_instr1  = TT_OP_UNPACR(0, 0b10001, 0, 0, 0, 1, 0, p_unpacr::RAREFYB_DISABLE, 0, p_unpacr::AUTO_INC_CONTEXT, 0, 0, 1); // unpack0 to dest, and increment Z for src-tile and dest
