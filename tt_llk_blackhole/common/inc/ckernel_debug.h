...
{
    ((volatile uint32_t*)MEM_LLK_DEBUG_BASE)[COMPILE_FOR_TRISC * 51 + 1 + offset] = value;
}
...
inline void dbg_close_runtime_dump(const uint32_t type, int32_t code = -1)
{
    ...
    ((volatile uint32_t*)MEM_LLK_DEBUG_BASE)[COMPILE_FOR_TRISC * 51] = type << 16 | code;
}

inline void dbg_init_runtime_dump()
{
    ((volatile uint32_t*)MEM_LLK_DEBUG_BASE)[COMPILE_FOR_TRISC * 51] = 0;
}
