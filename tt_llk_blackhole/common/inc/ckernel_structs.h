...
struct semaphore {
    ...
    constexpr static std::uint32_t PACK_DONE           = 4; // Wait for beinning and end of each pack-iteration.
    ...
    constexpr static std::uint16_t t6_sem(const std::uint8_t sem_index) { return (1 << sem_index); }
};
