...
#define TT_ADDDMAREG(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TT_INSN(false, TT_OP_ADDDMAREG(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex))
#define TTI_ADDDMAREG(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TTI_INSN(false, TT_OP_ADDDMAREG(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex))
...
#define TT_ADDRCRXY(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask)  TT_INSN(false, TT_OP_ADDRCRXY(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask))
#define TTI_ADDRCRXY(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask) TTI_INSN(false, TT_OP_ADDRCRXY(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask))
...
#define TT_ADDRCRZW_VALID(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask)                                                            \
    (ckernel::is_valid(CntSetMask, 3) && ckernel::is_valid(Ch1_Y, 6) && ckernel::is_valid(Ch1_X, 3) && ckernel::is_valid(Ch0_Y, 3) && \
     ckernel::is_valid(Ch0_X, 3) && ckernel::is_valid(BitMask, 6))
#define TT_ADDRCRZW(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask)  TT_INSN(false, TT_OP_ADDRCRZW(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask))
#define TTI_ADDRCRZW(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask) TTI_INSN(false, TT_OP_ADDRCRZW(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask))
...
#define TT_APOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst)  TT_INSN(false, TT_OP_APOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst))
#define TTI_APOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst) TTI_INSN(false, TT_OP_APOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst))
...
#define TT_APOOL3S2_VALID(clear_dvalid, pool_addr_mode, index_en, dst) \
    (ckernel::is_valid(clear_dvalid, 2) && ckernel::is_valid(pool_addr_mode, 7) && ckernel::is_valid(index_en, 1) && ckernel::is_valid(dst, 14))
#define TT_APOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst)  TT_INSN(false, TT_OP_APOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst))
#define TTI_APOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst) TTI_INSN(false, TT_OP_APOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst))
...
#define TTI_ATSWAP(MemHierSel, SwapMask, DataRegIndex, AddrRegIndex) TTI_INSN(false, TT_OP_ATSWAP(MemHierSel, SwapMask, DataRegIndex, AddrRegIndex))
...
#define TT_BITWOPDMAREG(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TT_INSN(false, TT_OP_BITWOPDMAREG(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex))
#define TTI_BITWOPDMAREG(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TTI_INSN(false, TT_OP_BITWOPDMAREG(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex))
...
#define TT_CFGSHIFTMASK(disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel, CfgReg) \
    TT_INSN(false, TT_OP_CFGSHIFTMASK(disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel, CfgReg))
#define TTI_CFGSHIFTMASK(disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel, CfgReg) \
    TTI_INSN(false, TT_OP_CFGSHIFTMASK(disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel, CfgReg))
...
#define TT_CLEARDVALID(cleardvalid, reset)       TT_INSN(false, TT_OP_CLEARDVALID(cleardvalid, reset))
#define TTI_CLEARDVALID(cleardvalid, reset)      TTI_INSN(false, TT_OP_CLEARDVALID(cleardvalid, reset))

#define TT_OP_CLREXPHIST TT_OP(0x21, 0)
#define TTI_CLREXPHIST   TTI_INSN(false, TT_OP_CLREXPHIST)
...
#define TT_CMPDMAREG(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TT_INSN(false, TT_OP_CMPDMAREG(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex))
#define TTI_CMPDMAREG(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TTI_INSN(false, TT_OP_CMPDMAREG(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex))
...
#define TT_CONV3S1(clear_dvalid, rotate_weights, addr_mode, dst)  TT_INSN(false, TT_OP_CONV3S1(clear_dvalid, rotate_weights, addr_mode, dst))
#define TTI_CONV3S1(clear_dvalid, rotate_weights, addr_mode, dst) TTI_INSN(false, TT_OP_CONV3S1(clear_dvalid, rotate_weights, addr_mode, dst))
...
#define TT_CONV3S2_VALID(clear_dvalid, rotate_weights, addr_mode, dst) \
    (ckernel::is_valid(clear_dvalid, 2) && ckernel::is_valid(rotate_weights, 5) && ckernel::is_valid(addr_mode, 3) && ckernel::is_valid(dst, 14))
#define TT_CONV3S2(clear_dvalid, rotate_weights, addr_mode, dst)  TT_INSN(false, TT_OP_CONV3S2(clear_dvalid, rotate_weights, addr_mode, dst))
#define TTI_CONV3S2(clear_dvalid, rotate_weights, addr_mode, dst) TTI_INSN(false, TT_OP_CONV3S2(clear_dvalid, rotate_weights, addr_mode, dst))
...
#define TT_DOTPV(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst) \
    TT_INSN(false, TT_OP_DOTPV(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst))
#define TTI_DOTPV(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst) \
    TTI_INSN(false, TT_OP_DOTPV(clear_dvalid, dest_accum_en, instr_mod19, addr_mode, dst))
...
#define TT_FLUSHDMA(FlushSpec)       TT_INSN(false, TT_OP_FLUSHDMA(FlushSpec))
#define TTI_FLUSHDMA(FlushSpec)      TTI_INSN(false, TT_OP_FLUSHDMA(FlushSpec))
...
#define TT_GATESRCRST(reset_srcb_gate_control, reset_srca_gate_control) \
    TT_INSN(false, TT_OP_GATESRCRST(reset_srcb_gate_control, reset_srca_gate_control))
#define TTI_GATESRCRST(reset_srcb_gate_control, reset_srca_gate_control) TTI_INSN(false, TT_OP_GATESRCRST(reset_srcb_gate_control, reset_srca_gate_control))
...
#define TT_INCADCXY(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X)  TT_INSN(false, TT_OP_INCADCXY(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X))
#define TTI_INCADCXY(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X) TTI_INSN(false, TT_OP_INCADCXY(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X))
...
#define TT_INCADCZW_VALID(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X)                                                                     \
    (ckernel::is_valid(CntSetMask, 3) && ckernel::is_valid(Ch1_Y, 6) && ckernel::is_valid(Ch1_X, 3) && ckernel::is_valid(Ch0_Y, 3) && \
     ckernel::is_valid(Ch0_X, 3))
#define TT_INCADCZW(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X)  TT_INSN(false, TT_OP_INCADCZW(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X))
#define TTI_INCADCZW(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X) TTI_INSN(false, TT_OP_INCADCZW(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X))
...
#define TT_INCRWC(rwc_cr, rwc_d, rwc_b, rwc_a)  TT_INSN(false, TT_OP_INCRWC(rwc_cr, rwc_d, rwc_b, rwc_a))
#define TTI_INCRWC(rwc_cr, rwc_d, rwc_b, rwc_a) TTI_INSN(false, TT_OP_INCRWC(rwc_cr, rwc_d, rwc_b, rwc_a))
...
#define TT_MFCONV3S1_VALID(clear_dvalid, rotate_weights, addr_mode, dst) \
    (ckernel::is_valid(clear_dvalid, 2) && ckernel::is_valid(rotate_weights, 5) && ckernel::is_valid(addr_mode, 3) && ckernel::is_valid(dst, 14))
#define TT_MFCONV3S1(clear_dvalid, rotate_weights, addr_mode, dst)  TT_INSN(false, TT_OP_MFCONV3S1(clear_dvalid, rotate_weights, addr_mode, dst))
#define TTI_MFCONV3S1(clear_dvalid, rotate_weights, addr_mode, dst) TTI_INSN(false, TT_OP_MFCONV3S1(clear_dvalid, rotate_weights, addr_mode, dst))
...
#define TT_MOP(mop_type, loop_count, zmask_lo16_or_loop_count)  TT_INSN(false, TT_OP_MOP(mop_type, loop_count, zmask_lo16_or_loop_count))
#define TTI_MOP(mop_type, loop_count, zmask_lo16_or_loop_count) TTI_INSN(false, TT_OP_MOP(mop_type, loop_count, zmask_lo16_or_loop_count))

#define TT_OP_MOP_CFG(zmask_hi16)    TT_OP(0x03, (((zmask_hi16) << 0)))
#define TT_MOP_CFG_VALID(zmask_hi16) (ckernel::is_valid(zmask_hi16, 24))
#define TT_MOP_CFG(zmask_hi16)       TT_INSN(false, TT_OP_MOP_CFG(zmask_hi16))
#define TTI_MOP_CFG(zmask_hi16)      TTI_INSN(false, TT_OP_MOP_CFG(zmask_hi16))
...
#define TT_MOVB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst) \
    TT_INSN(false, TT_OP_MOVB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst))
#define TTI_MOVB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst) TTI_INSN(false, TT_OP_MOVB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst))
...
#define TT_MOVD2B_VALID(dest_32b_lo, src, addr_mode, instr_mod, dst)                                                                         \
    (ckernel::is_valid(dest_32b_lo, 1) && ckernel::is_valid(src, 6) && ckernel::is_valid(addr_mode, 3) && ckernel::is_valid(instr_mod, 2) && \
     ckernel::is_valid(dst, 12))
#define TT_MOVD2B(dest_32b_lo, src, addr_mode, instr_mod, dst)  TT_INSN(false, TT_OP_MOVD2B(dest_32b_lo, src, addr_mode, instr_mod, dst))
#define TTI_MOVD2B(dest_32b_lo, src, addr_mode, instr_mod, dst) TTI_INSN(false, TT_OP_MOVD2B(dest_32b_lo, src, addr_mode, instr_mod, dst))
...
#define TTI_MOVDBGA2D(dest_32b_lo, src, addr_mode, instr_mod, dst) TTI_INSN(false, TT_OP_MOVDBGA2D(dest_32b_lo, src, addr_mode, instr_mod, dst))
...
#define TT_MOVDBGB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst) \
    TT_INSN(false, TT_OP_MOVDBGB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst))
#define TTI_MOVDBGB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst) TTI_INSN(false, TT_OP_MOVDBGB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst))
...
#define TT_MPOOL3S1_VALID(clear_dvalid, pool_addr_mode, index_en, dst) \
    (ckernel::is_valid(clear_dvalid, 2) && ckernel::is_valid(pool_addr_mode, 7) && ckernel::is_valid(index_en, 1) && ckernel::is_valid(dst, 14))
#define TT_MPOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst)  TT_INSN(false, TT_OP_MPOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst))
#define TTI_MPOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst) TTI_INSN(false, TT_OP_MPOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst))
...
#define TT_MPOOL3S2_VALID(clear_dvalid, pool_addr_mode, index_en, dst) \
    (ckernel::is_valid(clear_dvalid, 2) && ckernel::is_valid(pool_addr_mode, 7) && ckernel::is_valid(index_en, 1) && ckernel::is_valid(dst, 14))
#define TT_MPOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst)  TT_INSN(false, TT_OP_MPOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst))
#define TTI_MPOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst) TTI_INSN(false, TT_OP_MPOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst))
...
#define TT_MULDMAREG(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TT_INSN(false, TT_OP_MULDMAREG(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex))
#define TTI_MULDMAREG(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TTI_INSN(false, TT_OP_MULDMAREG(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex))
...
#define TT_PACR_SETREG(Push, ModeSel, Unused, DisableStall, AddrSel, StreamId, Flush, Last) \
    TT_INSN(false, TT_OP_PACR_SETREG(Push, ModeSel, Unused, DisableStall, AddrSel, StreamId, Flush, Last))
#define TTI_PACR_SETREG(Push, ModeSel, Unused, DisableStall, AddrSel, StreamId, Flush, Last) \
    TTI_INSN(false, TT_OP_PACR_SETREG(Push, ModeSel, Unused, DisableStall, AddrSel, StreamId, Flush, Last))

#define TT_OP_RAREB TT_OP(0x15, 0)
#define TTI_RAREB   TTI_INSN(false, TT_OP_RAREB)
...
#define TT_REG2FLOP(SizeSel, TargetSel, ByteOffset, ContextId_2, FlopIndex, RegIndex) \
    TT_INSN(false, TT_OP_REG2FLOP(SizeSel, TargetSel, ByteOffset, ContextId_2, FlopIndex, RegIndex))
#define TTI_REG2FLOP(SizeSel, TargetSel, ByteOffset, ContextId_2, FlopIndex, RegIndex) \
    TTI_INSN(false, TT_OP_REG2FLOP(SizeSel, TargetSel, ByteOffset, ContextId_2, FlopIndex, RegIndex))
...
#define TT_REPLAY(start_idx, len, execute_while_loading, load_mode)  TT_INSN(false, TT_OP_REPLAY(start_idx, len, execute_while_loading, load_mode))
#define TTI_REPLAY(start_idx, len, execute_while_loading, load_mode) TTI_INSN(false, TT_OP_REPLAY(start_idx, len, execute_while_loading, load_mode))
...
#define TT_RMWCIB0(Mask, Data, CfgRegAddr)       TT_INSN(false, TT_OP_RMWCIB0(Mask, Data, CfgRegAddr))
#define TTI_RMWCIB0(Mask, Data, CfgRegAddr)      TTI_INSN(false, TT_OP_RMWCIB0(Mask, Data, CfgRegAddr))
...
#define TT_RMWCIB1(Mask, Data, CfgRegAddr)       TT_INSN(false, TT_OP_RMWCIB1(Mask, Data, CfgRegAddr))
#define TTI_RMWCIB1(Mask, Data, CfgRegAddr)      TTI_INSN(false, TT_OP_RMWCIB1(Mask, Data, CfgRegAddr))
...
#define TT_RMWCIB2(Mask, Data, CfgRegAddr)       TT_INSN(false, TT_OP_RMWCIB2(Mask, Data, CfgRegAddr))
#define TTI_RMWCIB2(Mask, Data, CfgRegAddr)      TTI_INSN(false, TT_OP_RMWCIB2(Mask, Data, CfgRegAddr))
...
#define TT_RMWCIB3(Mask, Data, CfgRegAddr)       TT_INSN(false, TT_OP_RMWCIB3(Mask, Data, CfgRegAddr))
#define TTI_RMWCIB3(Mask, Data, CfgRegAddr)      TTI_INSN(false, TT_OP_RMWCIB3(Mask, Data, CfgRegAddr))

#define TT_OP_RSTDMA TT_OP(0x44, 0)
#define TTI_RSTDMA   TTI_INSN(false, TT_OP_RSTDMA)

#define TT_OP_SEMGET(sem_sel)    TT_OP(0xa5, (((sem_sel) << 2)))
#define TT_SEMGET_VALID(sem_sel) (ckernel::is_valid(sem_sel, 22))
#define TT_SEMGET(sem_sel)       TT_INSN(false, TT_OP_SEMGET(sem_sel))
#define TTI_SEMGET(sem_sel)      TTI_INSN(false, TT_OP_SEMGET(sem_sel))
...
#define TT_SEMINIT(max_value, init_value, sem_sel)       TT_INSN(false, TT_OP_SEMINIT(max_value, init_value, sem_sel))
#define TTI_SEMINIT(max_value, init_value, sem_sel)      TTI_INSN(false, TT_OP_SEMINIT(max_value, init_value, sem_sel))

#define TT_OP_SEMPOST(sem_sel)    TT_OP(0xa4, (((sem_sel) << 2)))
#define TT_SEMPOST_VALID(sem_sel) (ckernel::is_valid(sem_sel, 22))
#define TT_SEMPOST(sem_sel)       TT_INSN(false, TT_OP_SEMPOST(sem_sel))
#define TTI_SEMPOST(sem_sel)      TTI_INSN(false, TT_OP_SEMPOST(sem_sel))
...
#define TT_SEMWAIT(stall_res, sem_sel, wait_sem_cond)  TT_INSN(false, TT_OP_SEMWAIT(stall_res, sem_sel, wait_sem_cond))
#define TTI_SEMWAIT(stall_res, sem_sel, wait_sem_cond) TTI_INSN(false, TT_OP_SEMWAIT(stall_res, sem_sel, wait_sem_cond))
...
#define TT_SETADC(CntSetMask, ChannelIndex, DimensionIndex, Value)  TT_INSN(false, TT_OP_SETADC(CntSetMask, ChannelIndex, DimensionIndex, Value))
#define TTI_SETADC(CntSetMask, ChannelIndex, DimensionIndex, Value) TTI_INSN(false, TT_OP_SETADC(CntSetMask, ChannelIndex, DimensionIndex, Value))
...
#define TT_SETADCXX(CntSetMask, x_end2, x_start)       TT_INSN(false, TT_OP_SETADCXX(CntSetMask, x_end2, x_start))
#define TTI_SETADCXX(CntSetMask, x_end2, x_start)      TTI_INSN(false, TT_OP_SETADCXX(CntSetMask, x_end2, x_start))
...
#define TT_SETADCXY_VALID(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask)                                                            \
    (ckernel::is_valid(CntSetMask, 3) && ckernel::is_valid(Ch1_Y, 6) && ckernel::is_valid(Ch1_X, 3) && ckernel::is_valid(Ch0_Y, 3) && \
     ckernel::is_valid(Ch0_X, 3) && ckernel::is_valid(BitMask, 6))
#define TT_SETADCXY(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask)  TT_INSN(false, TT_OP_SETADCXY(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask))
#define TTI_SETADCXY(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask) TTI_INSN(false, TT_OP_SETADCXY(CntSetMask, Ch1_Y, Ch1_X, Ch0_Y, Ch0_X, BitMask))
...
#define TT_SETADCZW(CntSetMask, Ch1_W, Ch1_Z, Ch0_W, Ch0_Z, BitMask)  TT_INSN(false, TT_OP_SETADCZW(CntSetMask, Ch1_W, Ch1_Z, Ch0_W, Ch0_Z, BitMask))
#define TTI_SETADCZW(CntSetMask, Ch1_W, Ch1_Z, Ch0_W, Ch0_Z, BitMask) TTI_INSN(false, TT_OP_SETADCZW(CntSetMask, Ch1_W, Ch1_Z, Ch0_W, Ch0_Z, BitMask))
...
#define TT_SETASHRMH(reg_mask, halo_mask)       TT_INSN(false, TT_OP_SETASHRMH(reg_mask, halo_mask))
#define TTI_SETASHRMH(reg_mask, halo_mask)      TTI_INSN(false, TT_OP_SETASHRMH(reg_mask, halo_mask))
...
#define TT_SETASHRMH0(reg_mask, halo_mask)       TT_INSN(false, TT_OP_SETASHRMH0(reg_mask, halo_mask))
#define TTI_SETASHRMH0(reg_mask, halo_mask)      TTI_INSN(false, TT_OP_SETASHRMH0(reg_mask, halo_mask))
...
#define TT_SETASHRMH1(reg_mask, halo_mask)       TT_INSN(false, TT_OP_SETASHRMH1(reg_mask, halo_mask))
#define TTI_SETASHRMH1(reg_mask, halo_mask)      TTI_INSN(false, TT_OP_SETASHRMH1(reg_mask, halo_mask))
...
#define TT_SETC16(setc16_reg, setc16_value)       TT_INSN(false, TT_OP_SETC16(setc16_reg, setc16_value))
#define TTI_SETC16(setc16_reg, setc16_value)      TTI_INSN(false, TT_OP_SETC16(setc16_reg, setc16_value))
...
#define TT_SETDMAREG(Payload_SigSelSize, Payload_SigSel, SetSignalsMode, RegIndex16b) \
    TT_INSN(false, TT_OP_SETDMAREG(Payload_SigSelSize, Payload_SigSel, SetSignalsMode, RegIndex16b))
#define TTI_SETDMAREG(Payload_SigSelSize, Payload_SigSel, SetSignalsMode, RegIndex16b) \
    TTI_INSN(false, TT_OP_SETDMAREG(Payload_SigSelSize, Payload_SigSel, SetSignalsMode, RegIndex16b))
...
#define TT_SETIBRWC(rwc_cr, rwc_bias, set_inc_ctrl)  TT_INSN(false, TT_OP_SETIBRWC(rwc_cr, rwc_bias, set_inc_ctrl))
#define TTI_SETIBRWC(rwc_cr, rwc_bias, set_inc_ctrl) TTI_INSN(false, TT_OP_SETIBRWC(rwc_cr, rwc_bias, set_inc_ctrl))
...
#define TT_SETPKEDGOF(y_end, y_start, x_end, x_start)  TT_INSN(false, TT_OP_SETPKEDGOF(y_end, y_start, x_end, x_start))
#define TTI_SETPKEDGOF(y_end, y_start, x_end, x_start) TTI_INSN(false, TT_OP_SETPKEDGOF(y_end, y_start, x_end, x_start))
...
#define TT_SETRWC(clear_ab_vld, rwc_cr, rwc_d, rwc_b, rwc_a, BitMask) \
    TT_INSN(false, TT_OP_SETRWC(clear_ab_vld, rwc_cr, rwc_d, rwc_b, rwc_a, BitMask))
#define TTI_SETRWC(clear_ab_vld, rwc_cr, rwc_d, rwc_b, rwc_a, BitMask) TTI_INSN(false, TT_OP_SETRWC(clear_ab_vld, rwc_cr, rwc_d, rwc_b, rwc_a, BitMask))
...
#define TT_SFPLOAD(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr) \
    TT_INSN(true, TT_OP_SFPLOAD(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr))
#define TTI_SFPLOAD(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr) TTI_INSN(true, TT_OP_SFPLOAD(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr))
...
#define TT_SFPLOADMACRO(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr) \
    TT_INSN(true, TT_OP_SFPLOADMACRO(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr))
#define TTI_SFPLOADMACRO(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr) \
    TTI_INSN(true, TT_OP_SFPLOADMACRO(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr))
...
#define TTI_SFPNOP   TTI_INSN(true, TT_OP_SFPNOP)
...
#define TTI_SFPSHFT2(imm12_math, lreg_src_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPSHFT2(imm12_math, lreg_src_c, lreg_dest, instr_mod1))
...
#define TT_SFPSTORE(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr) \
    TT_INSN(true, TT_OP_SFPSTORE(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr))
#define TTI_SFPSTORE(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr) TTI_INSN(true, TT_OP_SFPSTORE(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr))
...
#define TTI_SFPSWAP(imm12_math, lreg_src_c, lreg_dest, instr_mod1) TTI_INSN(true, TT_OP_SFPSWAP(imm12_math, lreg_src_c, lreg_dest, instr_mod1))
...
#define TT_SHIFTDMAREG(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TT_INSN(false, TT_OP_SHIFTDMAREG(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex))
#define TTI_SHIFTDMAREG(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TTI_INSN(false, TT_OP_SHIFTDMAREG(OpBisConst, OpSel, ResultRegIndex, OpBRegIndex, OpARegIndex))
...
#define TT_STALLWAIT(stall_res, wait_res)       TT_INSN(false, TT_OP_STALLWAIT(stall_res, wait_res))
#define TTI_STALLWAIT(stall_res, wait_res)      TTI_INSN(false, TT_OP_STALLWAIT(stall_res, wait_res))
...
#define TT_STOREIND(MemHierSel, SizeSel, RegSizeSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex) \
    TT_INSN(false, TT_OP_STOREIND(MemHierSel, SizeSel, RegSizeSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex))
#define TTI_STOREIND(MemHierSel, SizeSel, RegSizeSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex) \
    TTI_INSN(false, TT_OP_STOREIND(MemHierSel, SizeSel, RegSizeSel, OffsetIndex, AutoIncSpec, DataRegIndex, AddrRegIndex))
...
#define TT_STREAMWAIT(stall_res, target_value, target_sel, wait_stream_sel) \
    TT_INSN(false, TT_OP_STREAMWAIT(stall_res, target_value, target_sel, wait_stream_sel))
#define TTI_STREAMWAIT(stall_res, target_value, target_sel, wait_stream_sel) \
    TTI_INSN(false, TT_OP_STREAMWAIT(stall_res, target_value, target_sel, wait_stream_sel))
...
#define TT_STREAMWRCFG(stream_id_sel, StreamRegAddr, CfgReg)  TT_INSN(false, TT_OP_STREAMWRCFG(stream_id_sel, StreamRegAddr, CfgReg))
#define TTI_STREAMWRCFG(stream_id_sel, StreamRegAddr, CfgReg) TTI_INSN(false, TT_OP_STREAMWRCFG(stream_id_sel, StreamRegAddr, CfgReg))
...
#define TT_SUBDMAREG(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TT_INSN(false, TT_OP_SUBDMAREG(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex))
#define TTI_SUBDMAREG(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex) \
    TTI_INSN(false, TT_OP_SUBDMAREG(OpBisConst, ResultRegIndex, OpBRegIndex, OpARegIndex))

#define TT_OP_TBUFCMD TT_OP(0x4b, 0)
#define TTI_TBUFCMD   TTI_INSN(false, TT_OP_TBUFCMD)

#define TT_OP_TRNSPSRCA TT_OP(0x14, 0)
#define TTI_TRNSPSRCA   TTI_INSN(false, TT_OP_TRNSPSRCA)

#define TT_OP_TRNSPSRCB TT_OP(0x16, 0)
#define TTI_TRNSPSRCB   TTI_INSN(false, TT_OP_TRNSPSRCB)
...
#define TT_XMOV(Mov_block_selection, Last)       TT_INSN(false, TT_OP_XMOV(Mov_block_selection, Last))
#define TTI_XMOV(Mov_block_selection, Last)      TTI_INSN(false, TT_OP_XMOV(Mov_block_selection, Last))
...
#define TT_ZEROSRC(zero_val, write_mode, bank_mask, src_mask)  TT_INSN(false, TT_OP_ZEROSRC(zero_val, write_mode, bank_mask, src_mask))
#define TTI_ZEROSRC(zero_val, write_mode, bank_mask, src_mask) TTI_INSN(false, TT_OP_ZEROSRC(zero_val, write_mode, bank_mask, src_mask))
