...
class ckernel_template
{
    ...
    const uint32_t m_outer_loop_len;
    const uint32_t m_inner_loop_len;
    uint32_t m_loop_op0;
    uint32_t m_loop_op1;
...
public:
    ...
    ckernel_template(uint32_t outer_loop_len, uint32_t inner_loop_len);
...
public:
    ...
    static constexpr uint32_t DEF_A_instr           = TT_OP_UNPACR(0, 0b1, 0, 0, 0, 0, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    static constexpr uint32_t DEF_A_cntx_ovrd_instr = TT_OP_UNPACR(0, 0b1, 0, 0, 0, 1, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);

    // Default B instruction with rarefy
    static constexpr uint32_t DEF_B_rarefy_instr = TT_OP_UNPACR(1, 0b01, 0, 0, 0, 0, 1, p_unpacr::RAREFYB_ENABLE, 0, 0, 0, 0, 1);

    // Default B instruction with rarefy and context override, coupled with halo on A
    static constexpr uint32_t DEF_B_rarefy_cntx_ovrd_instr = TT_OP_UNPACR(1, 0b01, 0, 0, 0, 1, 1, p_unpacr::RAREFYB_ENABLE, 0, 0, 0, 0, 1);

    // Default B instruction without rarefy, no z increment and with context override, coupled with halo on A for factored conv
    static constexpr uint32_t DEF_B_cntx_ovrd_no_z_inc_instr = TT_OP_UNPACR(1, 0b00, 0, 0, 0, 1, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    ...
    static constexpr uint32_t DEF_B_instr = TT_OP_UNPACR(1, 0b01, 0, 0, 0, 0, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);

    // Default halo A instructions
    static constexpr uint32_t DEF_A0_instr = TT_OP_UNPACR(
    ...
    static constexpr uint32_t DEF_A1_instr = TT_OP_UNPACR(
    ...
    static constexpr uint32_t DEF_A2_instr = TT_OP_UNPACR(
    ...
    static constexpr uint32_t DEF_A3_instr = TT_OP_UNPACR(
    ...
    static constexpr uint32_t DEF_A0_last_instr = TT_OP_UNPACR(
    ...
    static constexpr uint32_t DEF_A1_last_instr = TT_OP_UNPACR(
    ...
    static constexpr uint32_t DEF_A2_last_instr = TT_OP_UNPACR(
    ...
    static constexpr uint32_t SKIP_A0_instr = TT_OP_UNPACR(
    ...
    static constexpr uint32_t SKIP_A1_instr = TT_OP_UNPACR(
    ...
    static constexpr uint32_t SKIP_A2_instr = TT_OP_UNPACR(
    ...
    static constexpr uint32_t SKIP_A3_instr = TT_OP_UNPACR(
    ...
    static constexpr uint32_t DEF_A0_fconv_instr = TT_OP_UNPACR(
        0, 0b00, 0, p_unpacr::TILE0_CFG_CONTEXT, p_unpacr::TILE0_ADDRCNT_CONTEXT, 1, 0, p_unpacr::RAREFYB_DISABLE, 0, p_unpacr::AUTO_INC_CONTEXT, 1, 0, 1);
    static constexpr uint32_t DEF_A1_fconv_instr = TT_OP_UNPACR(
        0, 0b00, 0, p_unpacr::TILE1_CFG_CONTEXT, p_unpacr::TILE1_ADDRCNT_CONTEXT, 1, 0, p_unpacr::RAREFYB_DISABLE, 0, p_unpacr::AUTO_INC_CONTEXT, 1, 0, 1);
    static constexpr uint32_t DEF_A2_fconv_instr = TT_OP_UNPACR(
        0, 0b00, 0, p_unpacr::TILE2_CFG_CONTEXT, p_unpacr::TILE2_ADDRCNT_CONTEXT, 1, 0, p_unpacr::RAREFYB_DISABLE, 0, p_unpacr::AUTO_INC_CONTEXT, 1, 0, 1);
    static constexpr uint32_t DEF_A3_fconv_instr = TT_OP_UNPACR(
    ...
    static constexpr uint32_t DEF_A0_fconv_last_instr = TT_OP_UNPACR(
    ...
    static constexpr uint32_t DEF_A1_fconv_last_instr = TT_OP_UNPACR(
    ...
    static constexpr uint32_t DEF_A2_fconv_last_instr = TT_OP_UNPACR(
    ...
    static constexpr uint32_t DEF_Strip0_instr = TT_OP_UNPACR(0, 0, 0, 0, p_unpacr::TILE0_ADDRCNT_CONTEXT, 1, 0, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    static constexpr uint32_t DEF_Strip1_instr = TT_OP_UNPACR(0, 0, 0, 1, p_unpacr::TILE1_ADDRCNT_CONTEXT, 1, 0, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    static constexpr uint32_t DEF_Strip2_instr = TT_OP_UNPACR(0, 0, 0, 2, p_unpacr::TILE2_ADDRCNT_CONTEXT, 1, 0, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    static constexpr uint32_t DEF_Strip3_instr = TT_OP_UNPACR(0, 0, 0, 3, p_unpacr::TILE3_ADDRCNT_CONTEXT, 1, 0, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);

    static constexpr uint32_t DEF_Strip0_last_instr = TT_OP_UNPACR(0, 1, 0, 0, p_unpacr::TILE0_ADDRCNT_CONTEXT, 1, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    static constexpr uint32_t DEF_Strip1_last_instr = TT_OP_UNPACR(0, 1, 0, 1, p_unpacr::TILE1_ADDRCNT_CONTEXT, 1, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    static constexpr uint32_t DEF_Strip2_last_instr = TT_OP_UNPACR(0, 1, 0, 2, p_unpacr::TILE2_ADDRCNT_CONTEXT, 1, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    static constexpr uint32_t DEF_Strip3_last_instr = TT_OP_UNPACR(0, 1, 0, 3, p_unpacr::TILE3_ADDRCNT_CONTEXT, 1, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);

    static constexpr uint32_t DEF_Strip0_data_valid_instr =
        TT_OP_UNPACR(0, 0, 0, 0, p_unpacr::TILE0_ADDRCNT_CONTEXT, 1, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    static constexpr uint32_t DEF_Strip1_data_valid_instr =
        TT_OP_UNPACR(0, 0, 0, 1, p_unpacr::TILE1_ADDRCNT_CONTEXT, 1, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    static constexpr uint32_t DEF_Strip2_data_valid_instr =
        TT_OP_UNPACR(0, 0, 0, 2, p_unpacr::TILE2_ADDRCNT_CONTEXT, 1, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    static constexpr uint32_t DEF_Strip3_data_valid_instr =
        TT_OP_UNPACR(0, 0, 0, 3, p_unpacr::TILE3_ADDRCNT_CONTEXT, 1, 1, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);

    //
    // Convenience factory methods
    //
    static ckernel_unpack_template lzA(bool neginf, uint32_t A_instr = DEF_A_cntx_ovrd_instr, uint32_t skipA_instr = DEF_SKIP_A);

    static ckernel_unpack_template lA(uint32_t A_instr = DEF_A_cntx_ovrd_instr, uint32_t skipA_instr = DEF_SKIP_A);

    static ckernel_unpack_template lB(uint32_t B_instr = DEF_B_cntx_ovrd_instr, uint32_t skipB_instr = DEF_SKIP_B);
    ...
    static ckernel_unpack_template loopx1instr(uint32_t instr0, uint32_t skip0 = TT_OP_NOP);
    static ckernel_unpack_template loopx2instr(uint32_t instr0, uint32_t instr1, uint32_t skip0 = TT_OP_NOP, uint32_t skip1 = TT_OP_NOP);
...
inline ckernel_template::ckernel_template(uint32_t outer_loop_len, uint32_t inner_loop_len) :
...
inline ckernel_template::ckernel_template(uint32_t outer_loop_len, uint32_t inner_loop_len, uint32_t loop_op) :
    m_outer_loop_len(outer_loop_len),
    m_inner_loop_len(inner_loop_len),
    m_loop_op0(loop_op),
    m_loop_op1(TT_OP_NOP),
...
inline ckernel_template::ckernel_template(uint32_t outer_loop_len, uint32_t inner_loop_len, uint32_t loop_op0, uint32_t loop_op1) :
    m_outer_loop_len(outer_loop_len),
    m_inner_loop_len(inner_loop_len),
    m_loop_op0(loop_op0),
    m_loop_op1(loop_op1),
...
inline void ckernel_template::set_loop_op0(uint32_t loop_op)
{
    m_loop_op0 = loop_op;
}

inline void ckernel_template::set_loop_op1(uint32_t loop_op)
{
    m_loop_op1 = loop_op;
}

inline void ckernel_template::set_end_ops(uint32_t end_op0, uint32_t end_op1)
{
    m_end_op0 = end_op0;
    m_end_op1 = end_op1;
}

inline void ckernel_template::set_end_op(uint32_t end_op0)
{
    set_end_ops(end_op0, TT_OP_NOP);
}

inline void ckernel_template::set_start_op(uint32_t start_op0)
{
    m_start_op0 = start_op0;
}

inline void ckernel_template::set_last_inner_loop_instr(uint32_t op)
{
    m_loop1_last_instr = op;
}

inline void ckernel_template::set_last_outer_loop_instr(uint32_t op)
{
...
inline ckernel_unpack_template ckernel_unpack_template::lA(uint32_t A_instr, uint32_t skipA_instr)
{
...
inline ckernel_unpack_template ckernel_unpack_template::lB(uint32_t B_instr, uint32_t skipB_instr)
{
    return ckernel_unpack_template(
        false, // src B
        false, // halo
...
inline ckernel_unpack_template ckernel_unpack_template::lzA(bool neginf, uint32_t A_instr, uint32_t skipA_instr)
{
    return ckernel_unpack_template(
        false, // src B
        true,  // halo
...
inline ckernel_unpack_template ckernel_unpack_template::lhA(const uint32_t halo_mask)
{
    ...
    const uint32_t last_mask = (halo_mask == 0x1) ? 0x1 : (halo_mask <= 0x3) ? 0x2 : (halo_mask <= 0x7) ? 0x4 : 0;
...
inline ckernel_unpack_template ckernel_unpack_template::loopx1instr(uint32_t instr0, uint32_t skip0)
{
    return ckernel_unpack_template::lA(instr0, skip0);
}

inline ckernel_unpack_template ckernel_unpack_template::loopx2instr(uint32_t instr0, uint32_t instr1, uint32_t skip0, uint32_t skip1)
{
