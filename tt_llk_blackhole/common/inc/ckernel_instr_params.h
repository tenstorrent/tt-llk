...
struct p_pacr {
  ...
  constexpr static uint ALL_INTF_ACTIVE          = 0b000;
  constexpr static uint ALL_INTF_ACTIVE_ONES     = 0b000;
  constexpr static uint SINGLE_INTF_ACTIVE       = 0b001;
  constexpr static uint TWO_INTFS_ACTIVE         = 0b011;
  constexpr static uint THREE_INTFS_ACTIVE       = 0b101;
  constexpr static uint _0th_AND_2nd_INTF_ACTIVE = 0b100;
  constexpr static uint _1st_AND_3rd_INTF_ACTIVE = 0b010;
