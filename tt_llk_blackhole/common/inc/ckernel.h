...
inline void setup_default_packer_intf_masks() {
    //Setting up Packer Intf Sel Regs
    cfg_rmw(THCON_SEC0_REG14_Packer_Intf_Sel0_RMW,0b1111); //ALL_INTF_ACTIVE
    cfg_rmw(THCON_SEC0_REG14_Packer_Intf_Sel1_RMW,0b0001); //SINGLE_INTF_ACTIVE
    cfg_rmw(THCON_SEC0_REG14_Packer_Intf_Sel2_RMW,0b1010); //_1st_AND_3rd_INTF_ACTIVE
    cfg_rmw(THCON_SEC0_REG14_Packer_Intf_Sel3_RMW,0b0011); //TWO_INTFS_ACTIVE 
    cfg_rmw(THCON_SEC1_REG14_Packer_Intf_Sel0_RMW,0b0101); //_0th_AND_2nd_INTF_ACTIVE 
    cfg_rmw(THCON_SEC1_REG14_Packer_Intf_Sel1_RMW,0b0111); //THREE_INTFS_ACTIVE
    cfg_rmw(THCON_SEC1_REG14_Packer_Intf_Sel2_RMW,0b1111); //ALL_INTF_ACTIVE
    cfg_rmw(THCON_SEC1_REG14_Packer_Intf_Sel3_RMW,0b0101); //_0th_AND_2nd_INTF_ACTIVE
    } 
