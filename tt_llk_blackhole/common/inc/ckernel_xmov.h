...
{
    volatile uint32_t *XMOV_L1_BASE = reinterpret_cast<volatile uint32_t *>(RISCV_TDMA_REG_XMOV_L1_BASE_ADDR);
...
inline void xmov_cfg_instr_program(const risc_compact_mov_instrn_t xmov, const uint32_t l1_offset_16B, const uint32_t reg_addr32)
{
    ...
    volatile uint32_t *XMOV_CMD = reinterpret_cast<volatile uint32_t *>(RISCV_TDMA_REG_COMMAND_ADDR);
...
{
    volatile uint32_t *XMOV_CMD  = reinterpret_cast<volatile uint32_t *>(RISCV_TDMA_REG_COMMAND_ADDR);
    volatile uint32_t *SRC_ADDR  = reinterpret_cast<volatile uint32_t *>(RISCV_TDMA_REG_XMOV_SRC_ADDR);
    volatile uint32_t *DST_ADDR  = reinterpret_cast<volatile uint32_t *>(RISCV_TDMA_REG_XMOV_DST_ADDR);
    volatile uint32_t *SIZE_ADDR = reinterpret_cast<volatile uint32_t *>(RISCV_TDMA_REG_XMOV_SIZE);
    volatile uint32_t *DIR_ADDR  = reinterpret_cast<volatile uint32_t *>(RISCV_TDMA_REG_XMOV_DIRECTION);
...
{
    volatile uint32_t *XMOV_STATUS = reinterpret_cast<volatile uint32_t *>(RISCV_TDMA_REG_STATUS);
