...
template <ckernel::ApproximationMode APPROX_MODE, ActivationType ACTIVATION_TYPE>
...
template <ckernel::ApproximationMode APPROX_MODE, ActivationType ACTIVATION_TYPE, int ITERATIONS = 8>
...
template <ckernel::ApproximationMode APPROX_MODE, ActivationType ACTIVATION_TYPE, int ITERATIONS>
