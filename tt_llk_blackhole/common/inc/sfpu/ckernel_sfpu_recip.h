...
inline void _init_reciprocal_fast_8b_3c_()
{
...

    {
        ...
        constexpr uint32_t mad_bits    = 0x00 | 0x00 | (0 << 3) | (4 + 1);
        constexpr uint32_t round_bits  = 0;
        constexpr uint32_t store_bits  = 0x80 | 0x00 | (0 << 3) | 3;
    ...
    {
        constexpr uint32_t simple_bits = 0x80 | 0x40 | (5 << 3) | (4 + 3);
        constexpr uint32_t mad_bits    = 0x80 | 0x40 | (0 << 3) | (4 + 2);
        constexpr uint32_t round_bits  = 0;
...
inline void _init_reciprocal_fast_24b_5c_()
{
    ...
    {
        constexpr uint32_t simple_bits = 0x00 | 0x40 | (0 << 3) | (4 + 0);
        constexpr uint32_t mad_bits    = 0x00 | 0x00 | (2 << 3) | (4 + 1);
        constexpr uint32_t round_bits  = 0;
        constexpr uint32_t store_bits  = 0x00 | 0x00 | (2 << 3) | 3;
    ...
    // Macro 2: [t2]
    {
        constexpr uint32_t simple_bits = 0x80 | 0x00 | (2 << 3) | (4 + 3);
        constexpr uint32_t mad_bits    = 0x00 | 0x00 | (0 << 3) | (4 + 2);
    ...
    {
        constexpr uint32_t simple_bits = 0;
        constexpr uint32_t mad_bits    = 0x80 | 0x40 | (1 << 3) | (4 + 2);
        constexpr uint32_t round_bits  = 0;
    ...
    constexpr uint32_t prev_offset = -2 & 0x3ff;
