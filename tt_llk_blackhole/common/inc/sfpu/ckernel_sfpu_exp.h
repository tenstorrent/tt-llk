...
template <bool APPROXIMATION_MODE, bool SCALE_EN, int ITERATIONS, bool SKIP_POSITIVE_CHECK>
...
template <bool APPROXIMATION_MODE, uint32_t scale /* 1.0f in FP32 */>
...
template <bool APPROXIMATION_MODE>
inline void _init_exponential_piecewise_()
{
    if constexpr (APPROXIMATION_MODE)
    {
...
template <bool APPROXIMATION_MODE>
inline void _init_exponential_sdpa_first_column_()
{
    if constexpr (APPROXIMATION_MODE)
    {
        sfpi::vConstFloatPrgm0 = 1.442695f; // ln2_recip
