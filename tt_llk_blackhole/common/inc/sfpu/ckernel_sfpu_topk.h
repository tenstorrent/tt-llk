...
template <ApproximationMode APPROX_MODE, bool is_fp32_dest_acc_en, bool STABLE_SORT = false>
...
template <ApproximationMode APPROX_MODE, bool is_fp32_dest_acc_en, bool top_min, bool STABLE_SORT = false>
