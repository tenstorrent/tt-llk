    ...
    const std::uint32_t unpack_dst_format           = 0)
{
    ...
    // bool disable_src_zero_flag_val = disable_src_zero_flag || (static_cast<std::uint32_t>(unpack_dst_format) ==
    // static_cast<std::uint32_t>(DataFormat::UInt16)); cfg_reg_rmw_tensix<ALU_ACC_CTRL_Zero_Flag_disabled_src_RMW>(disable_src_zero_flag_val ? 1 : 0);
