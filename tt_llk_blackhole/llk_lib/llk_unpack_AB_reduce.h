...
inline void _llk_unpack_AB_reduce_mop_config_(const ckernel::TensorShape &tensor_shape)
{
    ...
    static constexpr std::uint32_t clear_pool_dep_srca =
        TT_OP_UNPACR_NOP(Srcs::SrcA, 0, 0, 0 /* dvalid */, 0, 1 /* Stall_Clr_Cntrl */, 0, pool_type == PoolType::MAX /* 0 or neginf */, p_unpacr_nop::CLR_SRC);
    static constexpr std::uint32_t clear_zero_srca =
        TT_OP_UNPACR_NOP(Srcs::SrcA, 0, 0, 0 /* dvalid */, 0, 1 /* Stall_Clr_Cntrl */, 0, p_unpacr_nop::CLR_SRC_0, p_unpacr_nop::CLR_SRC);
