...
inline void _llk_math_eltwise_ternary_sfpu_params_(
    Callable&& sfpu_func, uint dst_index0, uint dst_index1, uint dst_index2, uint dst_index_out, int vector_mode = (int)VectorMode::RC, Args&&... args)
{
    ...
    if (vector_mode == (int)VectorMode::R)
    {
        ...
        {
            std::forward<Callable>(sfpu_func)(dst_index0, dst_index1, dst_index2, dst_index_out, std::forward<Args>(args)...);
