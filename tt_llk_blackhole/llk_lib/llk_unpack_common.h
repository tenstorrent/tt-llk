...
{
    llk_san_unpack_hw_configure<true>(llk_san_x, unpack_src_format, llk_san_x, unpack_dst_format, llk_san_x, llk_san_x, llk_san_x, llk_san_x, llk_san_x);
...
{
    llk_san_unpack_hw_configure<true>(llk_san_x, llk_san_x, unpack_src_format, llk_san_x, unpack_dst_format, llk_san_x, llk_san_x, llk_san_x, llk_san_x);
