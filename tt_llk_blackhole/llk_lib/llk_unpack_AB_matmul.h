    ...
    if (reuse_a)
    {
        ...
        load_replay_buf(
            ...
            [unpA_partial_face]
            {
                ...
                {
                    TTI_UNPACR_NOP(SrcA, 0, 0, 0 /*Set Dvalid*/, 0, 0, 0, 0, p_unpacr_nop::UNP_ckernel::zerosrc);
                    TTI_UNPACR(
    ...
    else
    {
        ...
        load_replay_buf(
            ...
            [unpB_partial_face]
            {
                ...
                {
                    TTI_UNPACR_NOP(SrcB, 0, 0, 0 /*Set Dvalid*/, 0, 0, 0, 0, p_unpacr_nop::UNP_ckernel::zerosrc);
                    TTI_UNPACR(
