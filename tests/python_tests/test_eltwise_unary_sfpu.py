...
def test_eltwise_unary_sfpu(testname, formats, dest_acc, approx_mode, mathop):  #
    ...
    res_from_L1 = res_from_L1[:256] # this will be removed once we implement to read bytes from L1 according to data format (size of datum) which will be added in next PR
