...
def passed_test(golden_tensor, res_tensor, output_data_format=DataFormat.Float16_b):
    ...
    def get_tolerance(output_data_format):
        tolerances = {
            ...
            DataFormat.UInt32: Tolerance(atol=0.05, rtol=0.05),
            DataFormat.UInt16: Tolerance(atol=0.05, rtol=0.05),
            DataFormat.Int8: Tolerance(atol=0.1, rtol=0.2),
            DataFormat.UInt8: Tolerance(atol=0.1, rtol=0.2),
