...
struct FormatConfig
{
    ...
    FormatConfig& operator=(const FormatConfig& other) {
        if (this != &other) {
            unpack_A_src = other.unpack_A_src;
            unpack_B_src = other.unpack_B_src;
            unpack_A_dst = other.unpack_A_dst;
            unpack_B_dst = other.unpack_B_dst;
            math = other.math;
            pack_src = other.pack_src;
            pack_dst = other.pack_dst;
        }
