...
def test_sdpa_after_sub_matmul_shape(math_fidelity, workers_tensix_coordinates):
    ...
    configuration = TestConfig(
        "sources/sdpa_after_sub_matmul_shape_test.cpp",
        FORMATS,
    ...
    ), "matmul output after sub mismatch"
    assert passed_test(
