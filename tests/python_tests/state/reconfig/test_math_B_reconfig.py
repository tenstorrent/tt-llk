...
def get_valid_to_from_int8(
    ...
    from_a, from_b, to_b = format_triplet

    if from_a.is_integer() or from_b.is_integer() or to_b.is_integer():
        return True
...
def test_math_A_reconfig(
    ...
    configuration = TestConfig(
        "sources/state/reconfig/math_B_reconfig_test.cpp",
        ...
        FormatConfig(from_a, from_b, DataFormat.Float32, to_b, DataFormat.Float32),
        templates=[
