...
def gen_valid_format_triplet(
    ...
    return [
        *product(formats_float_a, formats_float_a, formats_float_a),
        *product(formats_float_b, formats_float_b, formats_float_b),
        *product(formats_integer, formats_integer, formats_integer),
    ]


def get_valid_to_from_int8(
    format_triplet: tuple[DataFormat, DataFormat, DataFormat],
) -> bool:
    from_a, from_b, to_a = format_triplet

    if from_a.is_integer() or from_b.is_integer() or to_a.is_integer():
        return True
...
@parametrize(
    format_triplet=gen_valid_format_triplet(
        [
            DataFormat.Float16,
    ...
    to_from_int8=lambda format_triplet: get_valid_to_from_int8(format_triplet),
...
def test_math_A_reconfig(
    ...
    configuration = TestConfig(
        "sources/state/reconfig/math_A_reconfig_test.cpp",
        ...
        FormatConfig(from_a, from_b, to_a, DataFormat.Float32, DataFormat.Float32),
        templates=[
