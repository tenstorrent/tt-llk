...
def test_sdpa_sub_block_rows_single_section(workers_tensix_coordinates):
    ...
    configuration = TestConfig(
        "sources/sdpa_sub_block_rows_single_section_test.cpp",
        FORMATS,
    ...
    if TestConfig.MODE == TestMode.PRODUCE:
        raise RuntimeError(TestConfig.SKIP_JUST_FOR_COMPILE_MARKER)
