...
def test_matmul(
    ...
    all_counters = [
        ...
        counter("L1", "NOC_RING0_INCOMING_0", mux_ctrl_bit4=0),
        counter("L1", "NOC_RING0_OUTGOING_1", mux_ctrl_bit4=0),
        counter("L1", "NOC_RING0_OUTGOING_0", mux_ctrl_bit4=0),
        ...
        counter("L1", "L1_NO_ARB_UNPACKER", mux_ctrl_bit4=0),
        # L1 mux=1
        counter("L1", "NOC_RING1_INCOMING_1", mux_ctrl_bit4=1),
        counter("L1", "NOC_RING1_INCOMING_0", mux_ctrl_bit4=1),
        counter("L1", "NOC_RING1_OUTGOING_1", mux_ctrl_bit4=1),
        counter("L1", "NOC_RING1_OUTGOING_0", mux_ctrl_bit4=1),
        counter("L1", "TDMA_BUNDLE_1_ARB", mux_ctrl_bit4=1),
        counter("L1", "TDMA_BUNDLE_0_ARB", mux_ctrl_bit4=1),
        counter("L1", "TDMA_EXT_UNPACK_9_10", mux_ctrl_bit4=1),
        counter("L1", "TDMA_PACKER_2_WR", mux_ctrl_bit4=1),
        # TDMA_PACK (8)
