...
void run_kernel(const volatile struct RuntimeParams* params)
{
    ...
    // write_idx must be zero before the first push (test infrastructure zeroes stream memory)
...
void run_kernel(const volatile struct RuntimeParams* params)
{
    ...
    // read_idx must be zero before the first pop (test infrastructure zeroes stream memory)
