...
void run_kernel()
{
    ...
    if constexpr (version == 0 || version == 1 || version == 2 || version == 3) { // ERR, ERR SHIFTOPT, NERR, NERR SHIFTOPT
    ...
    } else if constexpr (version == 16 || version == 17) { // TSXATINC TSXATINCPTR
    ...
    } else if constexpr (version == 18 || version == 19) { // TSXFULLATINC TSXFULLATINCPTR
