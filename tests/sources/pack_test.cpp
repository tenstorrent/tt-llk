...
#else
    _llk_pack_hw_configure_<is_fp32_dest_acc_en, false>(formats.pack_src, formats.pack_dst, 16 * 16 * 4, FACE_R_DIM, num_faces, true);
    _llk_pack_init_<false, zero_output_en, DstTileFaceLayout::RowMajor, false>(formats.pack_dst, FACE_R_DIM, num_faces, true);
