...
constexpr int ITERATIONS               = 32; // Dependent on size of input tensor (1024 currently). Could be made dynamic once tensor size becomes variable.
...
void run_kernel(const volatile struct RuntimeParams *params)
{
    ...
    CALL_SFPU_OPERATION(formats_array[run].math, 5.0f)
