...
void run_kernel()
{
    ...
    _llk_unpack_AB_matmul_hw_configure_<is_fp32_dest_acc_en, StochRndType::None>(UNPACK_IN, UNPACK_IN, UNPACK_OUT, UNPACK_OUT,FACE_R_DIM,FACE_R_DIM,0,4,4,tile_size,tile_size);
...
void run_kernel()
{
    ...
    _llk_math_hw_configure_<true,false>(UNPACK_OUT,UNPACK_OUT);
