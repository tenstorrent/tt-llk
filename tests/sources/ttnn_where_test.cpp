...
void run_kernel()
{
    ...
    volatile uint32_t* const buffer_condition = buffer_A[0];
    volatile uint32_t* const buffer_true      = buffer_B[0];
    volatile uint32_t* const buffer_false     = buffer_C[0];
...
void run_kernel()
{
    ...
    volatile uint32_t* const buffer_Dest = buffer_Res[0];
