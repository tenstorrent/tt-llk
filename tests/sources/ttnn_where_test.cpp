...
void run_kernel()
{
    ...
    volatile uint32_t const buffer_condition = 0x1a000;
    volatile uint32_t const buffer_true      = 0x1b000;
    volatile uint32_t const buffer_false     = 0x1c000;
...
void run_kernel()
{
    ...
    volatile uint32_t const buffer_Dest = 0x1d000;
