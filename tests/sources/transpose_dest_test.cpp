...
void run_kernel()
{
    ...
    _llk_pack_init_<false, false, false, false>(formats.pack_dst, FACE_R_DIM, TILE_C_DIM, num_of_faces);
    ...
    _llk_pack_init_<false, false, false>(formats.pack_dst, FACE_R_DIM, num_of_faces);
