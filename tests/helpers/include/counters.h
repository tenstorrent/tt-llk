...
public:
    ...
    void start(std::uint32_t zone)
    {
        ...
        // Thread 0 arms counters. Other threads read the same registers
        // (same bus latency) to equalize pre-barrier delay.
        // Called via asm from the macro — zero impact on caller's codegen.
