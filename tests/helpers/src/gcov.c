...
#define GCOV_DATA_MAGIC          ((gcov_unsigned_t)0x67636461)
    ...
    void __gcov_merge_add([[maybe_unused]] gcov_type *counters, [[maybe_unused]] unsigned n_counters)
    {
    }
    ...
    static void write_one_data(
        ...
        [[maybe_unused]] const struct gcov_summary *prg_p,
        void (*dump_fn)(const void *, unsigned, void *),
        [[maybe_unused]] void *(*allocate_fn)(unsigned, void *),
        void *arg)
    {
        unsigned f_ix;
