...
inline void _llk_unpack_untilize_mop_config_() {
    ...
    static constexpr std::uint32_t unpack_addcr          = TT_OP_NOP;
    static constexpr std::uint32_t unpack_addr_offset    = TT_OP_NOP;
    static constexpr std::uint32_t unpack_wr_addr_offset = TT_OP_NOP;
#else
    static constexpr std::uint32_t unpack_srca =
        TT_OP_UNPACR(SrcA, 0b01000001, 0, 0, 0, 0, 0, p_unpacr::RAREFYB_DISABLE, 0, 0, 0, 0, 1);
    static constexpr std::uint32_t unpack_addcr = TT_OP_ADDRCRZW(0b001, 0, 0, 0, 0, 0b0001);
    static constexpr std::uint32_t unpack_addr_offset =
        TT_OP_ADDDMAREG(0, p_gpr_unpack::TILE_OFFSET, p_gpr_unpack::TILE_OFFSET, p_gpr_unpack::TILE_SIZE);
    static constexpr std::uint32_t unpack_wr_addr_offset = TT_OP_REG2FLOP(
