...
#if SKIP_UNP == 1
    constexpr static std::uint32_t CLR_A  = 0x0;
    constexpr static std::uint32_t CLR_B  = 0x0;
    constexpr static std::uint32_t CLR_AB = 0x0;
#else
...
struct p_unpacr {
    ...
    constexpr static std::uint32_t AUTO_INC_CONTEXT =
        (1); // Auto increment config context (max value set through unpacker config command)

    constexpr static std::uint32_t UNP_POP             = 0x0;
    constexpr static std::uint32_t UNP_ZEROSRC         = 0x1;
    constexpr static std::uint32_t UNP_NOP             = 0x2;
    constexpr static std::uint32_t UNP_NEGINFSRC       = 0x5;
    constexpr static std::uint32_t UNP_RESET_ALL_BANKS = 0x8;
};
...
struct p_stall {
    ...
    // constexpr static std::uint32_t SEM_ZERO    = 0x20;
    // constexpr static std::uint32_t SEM_MAX     = 0x40;
    ...
    constexpr static std::uint32_t STALL_XSEARCH = 0x10;
    constexpr static std::uint32_t STALL_XMOV    = 0x20;
    constexpr static std::uint32_t STALL_THCON   = 0x40;
    constexpr static std::uint32_t STALL_MATH    = 0x80;
    constexpr static std::uint32_t STALL_CFG     = 0x100;
...
struct p_shiftx {
    ...
    constexpr static std::uint32_t COMBINED     = 0x0;
    constexpr static std::uint32_t ROTATE       = 0x1;
    constexpr static std::uint32_t INDEPENDANT  = 0x2;
    constexpr static std::uint32_t HALOIZE_MODE = 0x3;
};
...
struct p_sfpu {
    ...
    constexpr static std::uint32_t LCONST_0           = 4;
    constexpr static std::uint32_t LCONST_ln2         = 5;
    constexpr static std::uint32_t LCONST_ln2_recip   = 7;
    constexpr static std::uint32_t LCONST_neg_point_5 = 9;
