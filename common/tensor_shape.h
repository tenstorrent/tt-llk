...
{
    if (!(tensor_shape.total_num_faces() == 1 || tensor_shape.total_num_faces() == 2 || tensor_shape.total_num_faces() == 4))
    {
        return false;
    }
    if (!(tensor_shape.face_r_dim == 1 || tensor_shape.face_r_dim == 2 || tensor_shape.face_r_dim == 4 || tensor_shape.face_r_dim == 8 ||
          tensor_shape.face_r_dim == 16))
    {
        return false;
    }
    if (tensor_shape.face_c_dim != 16)
    {
        return false;
    }
    return true;
